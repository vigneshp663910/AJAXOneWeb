...
namespace Business
{
    public class BDMS_WebQuotation
    {
        private IDataAccess provider;
        public BDMS_WebQuotation()
        {
            try
            {
            ...
            {
                new FileLogger().LogMessageService("BDMS_WebQuotation", "provider : " + e1.Message, null);
            }
        }
        public long InsertOrUpdateWebQuotationBasicInformation(PDMS_WebQuotation SalesOrder)
        {
            int success = 0;

            DbParameter WebQuotationID = provider.CreateParameter("WebQuotationID", SalesOrder.WebQuotationID, DbType.Int64);

           // DbParameter SalesOrderNumber = provider.CreateParameter("SalesOrderNumber", SalesOrder.SalesOrderNumber, DbType.String);
           // DbParameter SalesOrderDate = provider.CreateParameter("SalesOrderDate", SalesOrder.SalesOrderDate, DbType.DateTime);

           // DbParameter PurchaseOrderNumber = provider.CreateParameter("PurchaseOrder", SalesOrder.PrimaryPurchaseOrder.PurchaseOrderNumber, DbType.String);
           // DbParameter PurchaseOrderDate = provider.CreateParameter("PurchaseOrderDate", SalesOrder.PrimaryPurchaseOrder.PurchaseOrderDate, DbType.DateTime);
            ...
            DbParameter[] Params = new DbParameter[28] { WebQuotationID,
               // SalesOrderNumber,SalesOrderDate,PurchaseOrderNumber,PurchaseOrderDate,
        ...
        public Boolean InsertOrUpdateWebQuotationFocInformation(PDMS_WebQuotation SalesOrder)
        {
            int success = 0;
            DbParameter WebQuotationID = provider.CreateParameter("WebQuotationID", SalesOrder.WebQuotationID, DbType.Int64);
        ...
        public Boolean InsertOrUpdateWebQuotationFinanceInformation(PDMS_WebQuotation SalesOrder)
        {
            int success = 0;
            DbParameter WebQuotationID = provider.CreateParameter("WebQuotationID", SalesOrder.WebQuotationID, DbType.Int64);
        ...
        public Boolean InsertOrUpdateWebQuotationItem(PDMS_WebQuotationItem Item)
        {
            try
            {
                using (TransactionScope scope = new TransactionScope(TransactionScopeOption.RequiresNew))
        ...
        public Boolean InsertOrUpdateWebQuotationSalesInformation(PDMS_WebQuotation SalesOrder)
        {
            int success = 0;
            DbParameter WebQuotationID = provider.CreateParameter("WebQuotationID", SalesOrder.WebQuotationID, DbType.Int64);
        ...
        public Boolean UpdateWebQuotationSapStatus(long WebQuotationID, Boolean IsSuccess)
        {
            int success = 0;
        ...
        public Boolean ApproveWebQuotation(long WebQuotationID, Int16 StatusID, int UserID)
        {
            int success = 0;
            DbParameter WebQuotationIDP = provider.CreateParameter("WebQuotationID", WebQuotationID, DbType.Int64);
        ...
        public List<PDMS_WebQuotation> GetWebQuotationByID(long? WebQuotationID, string PurchaseOrderNumber)
        {
        ...
        public List<PDMS_WebQuotationItem> GetWebQuotationItem(long? WebQuotationID, long? WebQuotationItemID)
        {
            List<PDMS_WebQuotationItem> Ws = new List<PDMS_WebQuotationItem>();
        ...
        public List<PDMS_WebQuotation> GetWebQuotation(string PONumber, DateTime? PODateFrom, DateTime? PODateTo, string SONumber, DateTime? SODateFrom, DateTime? SODateTo
        ...
        public List<PDMS_WebQuotation> GetWebQuotationForApproval()
        {
            List<PDMS_WebQuotation> Ws = new List<PDMS_WebQuotation>();
            PDMS_WebQuotation W = null;
            try
