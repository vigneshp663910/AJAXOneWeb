...
namespace Business
{
    public class BDMS_WarrantyClaim
    {
        ...
        public DataSet ZYA_GetWarrantyCostPerMachine(string ManufacturingDateF, string ManufacturingDateT, string AsOnDate, string Dealer, string Region, string ServiceType, string Division, string Model, int Excel = 0)
        {
        ...
        public DataSet ZYA_GetIncidentPer100Machine(string ManufacturingDateF, string ManufacturingDateT, string AsOnDate, string Dealer, string Region, string ServiceType, string Division, string Model, int Excel = 0)
        {
