...
namespace Business
{
    public class BDMS_ImageCompress
    {
        ...
        #region[PrivateData]
        private static volatile BDMS_ImageCompress imageCompress;
        ...
        /// </summary>
        public static BDMS_ImageCompress GetImageCompressObject
        {
            get
            {
                if (imageCompress == null)
                {
                    imageCompress = new BDMS_ImageCompress();
                }
        ...
        public void Save(string fileName, string path,int QualityPer)
        {
            if (ISValidFileType(fileName))
            {
                string pathaname = path + @"\" + fileName;
                save(pathaname, QualityPer);
            }
        }
