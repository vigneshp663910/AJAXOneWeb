...
namespace Business
{
    public class BColdVisit
    {
        ...
        public List<PColdVisit> GetColdVisit(long? ColdVisitID, string ColdVisitNumber, DateTime? ColdVisitDateFrom, DateTime? ColdVisitDateTo, long? CustomerID, string CustomerCode, string CustomerName, string Mobile, int? CountryID, int? RegionID, int? ReferenceTableID, long? ReferenceID, int? DealerID, int? SalesEngineerID,int? ActionTypeID)
        {
            string endPoint = "ColdVisit?ColdVisitID=" + ColdVisitID + "&ColdVisitNumber=" + ColdVisitNumber + "&ColdVisitDateFrom=" + ColdVisitDateFrom + "&ColdVisitDateTo=" + ColdVisitDateTo + "&CustomerID=" + CustomerID
                + "&CustomerCode=" + CustomerCode + "&CustomerName=" + CustomerName + "&Mobile=" + Mobile + "&CountryID=" + CountryID + "&RegionID=" + RegionID + "&ReferenceTableID=" + ReferenceTableID + "&ReferenceID=" + ReferenceID 
        ...
        public DataTable GetColdVisitExcelDownload(long? ColdVisitID, DateTime? ColdVisitDateFrom, DateTime? ColdVisitDateTo, long? CustomerID, string CustomerCode, string CustomerName, string Mobile, int? CountryID, int? RegionID, int? ReferenceTableID, long? ReferenceID, int? DealerID, int? SalesEngineerID, int? ActionTypeID)
        {
