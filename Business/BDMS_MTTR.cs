...
namespace Business
{
    public class BDMS_MTTR
    {
        ...
        public List<PDMS_MTTR_New> GetMTTR(string DealerCode, string CustomerCode, string ICTicketNumber, DateTime? ICTicketDateF, DateTime? ICTicketDateT, int? ServiceStatusID, int UserID, string Division)
        {
            List<PDMS_MTTR_New> Ws = new List<PDMS_MTTR_New>();
            PDMS_MTTR_New W = null;
            try
            {
                ...
                DbParameter[] Params = new DbParameter[8] { DealerCodeP, CustomerCodeP, ICTicketNumberP, ICTicketDateFP, ICTicketDateTP, ServiceStatusIDP, UserIDP, DivisionP };
                using (DataSet DataSet = provider.Select("ZDMS_GetMTTR", Params))
                {
                    if (DataSet != null)
                    {
                        foreach (DataRow dr in DataSet.Tables[0].Rows)
                        {
                            ...
                            W.ICTicket.FSRDate = dr["FSRDate"] == DBNull.Value ? (DateTime?)null : Convert.ToDateTime(dr["FSRDate"]);//Convert.ToString(dr["FSRDate"]);
                            //if (dr["CustomerSatisfactionLevelID"] != DBNull.Value)
                            //    W.ICTicket.CustomerSatisfactionLevel = new PDMS_CustomerSatisfactionLevel()
                            //    {
                            ...
                            W.ICTicket.Address = new PDMS_Address();
                            W.ICTicket.Address.Region = new PDMS_Region() { Region = Convert.ToString(dr["Region"]) };
                            W.ICTicket.Address.State = new PDMS_State() { State = Convert.ToString(dr["State"]) };
                            W.ICTicket.Address.District = new PDMS_District() { District = Convert.ToString(dr["District"]) };
                            W.ICTicket.Location = Convert.ToString(dr["District"]);
                            W.ICTicket.Material = new PDMS_Material();
                            ...
                            W.code = Convert.ToString(dr["Code"]);
                            W.description1 = Convert.ToString(dr["CodeDescription"]);
                            ...
                            //else if ("SER 00008" == W.ICTicket.Material.MaterialCode)
                            //{
                            //    W.code = "PWC";
                            //    W.description1 = "PWC";
                            //}

                            //else if ("SER 00009" == W.ICTicket.Material.MaterialCode)
                            //{
                            //    W.code = "PLC";
                            //    W.description1 = "PLC";
                            //}
                            ...
                            W.ICTicket.Equipment.DispatchedOn = dr["DispatchedOn"] == DBNull.Value ? (DateTime?)null : Convert.ToDateTime(dr["DispatchedOn"]);
                            W.ICTicket.Equipment.CommissioningOn = dr["CommissioningOn"] == DBNull.Value ? (DateTime?)null : Convert.ToDateTime(dr["CommissioningOn"]);
                            W.ICTicket.Equipment.WarrantyExpiryDate = dr["WarrantyExpiryDate"] == DBNull.Value ? (DateTime?)null : Convert.ToDateTime(dr["WarrantyExpiryDate"]); //Convert.ToDateTime(dr["WarrantyExpiryDate"]);
                            // W.ICTicket.Equipment.warrantyStartDate = dr["warrantyStartDate"] == DBNull.Value ? (DateTime?)null : Convert.ToDateTime(dr["warrantyStartDate"]); //Convert.ToDateTime(dr["warrantyStartDate"]);
                            ...
                            W.ICTicket.ICPriority = new PDMS_ServicePriority() { ServicePriority = Convert.ToString(dr["ICPriority"]) };

                            //if (DBNull.Value != dr["ServicePriorityID"])
                            //    W.ICTicket.ServicePriority = new PDMS_ServicePriority() { ServicePriorityID = Convert.ToInt32(dr["ServicePriorityID"]), ServicePriority = Convert.ToString(dr["ServicePriority"]) };

                            W.ICTicket.ServicePriority = new PDMS_ServicePriority() { ServicePriority = Convert.ToString(dr["ServicePriority"]) };
                            ...
                            W.ICTicket.RegisteredBy = new PUser() { ContactName = Convert.ToString(dr["RegisteredByName"]) };
                            ...
                            W.ICTicket.HillyRegion = dr["HillyRegion"] == DBNull.Value ? false : Convert.ToBoolean(dr["HillyRegion"]);
                            W.ICTicket.MarginRemark = Convert.ToString(dr["MarginRemark"]);
                            W.IsNew = Convert.ToBoolean(dr["IsNew"]);

                            W.ICTicket.ReqDeclinedReason = Convert.ToString(dr["DeclineReason"]);
