...
namespace Business
{
    public class FileLogger: System.Web.UI.Page
    {
        ...
        public void LogMessage(string ServiceName, string message, Exception e)
        { 
            WriteLog("User : \t"+ PSession.User.UserID + DateTime.Now.ToString() + "\n" + ServiceName + "\t" + message + "\t" + Convert.ToString(e));
        }
        public void LogMessageService(string ServiceName, string message, Exception e)
        { 
        ...
        public void WriteLog(string Message)
        {
            try
            {
                string endPoint = "File/LogWebMessage?Message=" + Message;
                new BAPI().ApiGet(endPoint); 
            }
            catch
            { 
            }
