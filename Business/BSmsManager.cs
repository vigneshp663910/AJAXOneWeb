    ...
    public class BSmsManager
    {
        ...
        public Boolean SendSMS(string sendToPhoneNumber, string Message)
        {
            ...
            try
            {
                ...
                String url = "https://enterprise.smsgupshup.com/GatewayAPI/rest?method=sendMessage&send_to=" + sendToPhoneNumber + "&msg=" + Message + "&userid=" + userid + "&password=" + passwd + "&v=1.1 & msg_type=TEXT&auth_scheme=PLAIN";
