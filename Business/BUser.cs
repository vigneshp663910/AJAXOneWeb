...
namespace Business
{
    public class BUser
    {
        ...
        {
            string endPoint = "User/GetUserDetails?userID=" + userID; 
            PApiResult Results = JsonConvert.DeserializeObject<PApiResult>(new BAPI().ApiGet(endPoint));
            if (Results.Status == PApplication.Failure)
            {
                throw new Exception(Results.Message);
            } 
           return   JsonConvert.DeserializeObject<PUser>(JsonConvert.SerializeObject(Results.Data));
            ...
            //    using (DataTable userData = GetLoginUserDetails())
            //    {
            //        if (userData.Rows.Count > 0)
            //            userAuthDetails = ConvertToUser(userData.Rows[0]);
        ...
        {
            string endPoint = "User/AuthenticateUser?userName=" + userName;
            PApiResult Results = JsonConvert.DeserializeObject<PApiResult>(new BAPI().ApiGet(endPoint));
            if (Results.Status == PApplication.Failure)
            {
                throw new Exception(Results.Message);
        ...
        public List<PUser> GetUsersActivityTracking(long? UserID, string UserName, int? UserTypeID, string ExternalReferenceID, int? DealerID, bool? IsEnabled
            , string ContactName, int? DealerDepartmentID, int? DealerDesignationID, bool? IsLocked,   int? PageIndex, int? PageSize, out int RowCount)
        {
            RowCount = 0;

            string endPoint = "User/GetUsersActivityTracking?UserID=" + UserID + "&UserName=" + UserName + "&UserTypeID=" + UserTypeID 
                + "&ExternalReferenceID=" + ExternalReferenceID + "&DealerID=" + DealerID + "&ContactName=" + ContactName
                + "&DealerDepartmentID=" + DealerDepartmentID + "&DealerDesignationID=" + DealerDesignationID + "&IsLocked=" + IsLocked 
        ...
        {            
            ...
            return JsonConvert.DeserializeObject<List<PSubModuleChild>>(JsonConvert.SerializeObject(Results.Data));
        }
        public List<PSubModuleAccess> GetSubModuleMaster(int? ModuleMasterID, int? SubModuleMasterID, string SubModuleName)
        {
            ...
            return JsonConvert.DeserializeObject<List<PSubModuleAccess>>(JsonConvert.SerializeObject(Results.Data));
        }
        ...
        {
            string endPoint = "User/GetUserByModulePermissions?DealerID=" + DealerID + "&DepartmentID=" + DepartmentID + "&DesignationID=" + DesignationID
                + "&ModuleMasterID=" + ModuleMasterID + "&SubModuleMasterID=" + SubModuleMasterID + "&SubModuleChildID=" + SubModuleChildID;
            PApiResult Results = JsonConvert.DeserializeObject<PApiResult>(new BAPI().ApiGet(endPoint));
            if (Results.Status == PApplication.Failure)
            {
                throw new Exception(Results.Message);
        ...
        {
            string endPoint = "User/GetDMSModuleByUser?UserId=" + UserId + "&ModuleMasterID=" + ModuleMasterID + "&SubModuleMasterID=" + SubModuleMasterID + "&All=" + All;
            PApiResult Results = JsonConvert.DeserializeObject<PApiResult>(new BAPI().ApiGet(endPoint));
            if (Results.Status == PApplication.Failure)
            {
                throw new Exception(Results.Message);
        ...
        {
            string endPoint = "User/GetDMSModuleAll";
            PApiResult Results = JsonConvert.DeserializeObject<PApiResult>(new BAPI().ApiGet(endPoint));
            if (Results.Status == PApplication.Failure)
            {
                throw new Exception(Results.Message);
        ...
        {
            string endPoint = "User/RejectUserMobile?UserMobileID=" + UserMobileID + "&Remarks=" + Remarks;
            PApiResult Results = JsonConvert.DeserializeObject<PApiResult>(new BAPI().ApiGet(endPoint));
            if (Results.Status == PApplication.Failure)
            {
                throw new Exception(Results.Message);
        ...
        {
            string endPoint = "User/GetDMSModuleByByDealerDesignationID?DealerDesignationID=" + DealerDesignationID;
            PApiResult Results = JsonConvert.DeserializeObject<PApiResult>(new BAPI().ApiGet(endPoint));
            if (Results.Status == PApplication.Failure)
            {
                throw new Exception(Results.Message);
        ...
        {
            string endPoint = "User/GetUserLocationTrack?UserID=" + UserID ;
            PApiResult Results = JsonConvert.DeserializeObject<PApiResult>(new BAPI().ApiGet(endPoint));
            if (Results.Status == PApplication.Failure)
            {
                throw new Exception(Results.Message);
