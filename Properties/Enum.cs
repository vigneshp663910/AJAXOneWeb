...
namespace Properties
{
    ...
    public enum SubModule
    {
        ...
        ViewAdmin_UserAccessByModule = 265,
    ...
    public enum Jobs
    {
        ...
        RebuildMasterIndex = 7,
        RebuildPreSaleIndex = 8,
        RebuildProcurementSalesIndex = 9,
        RebuildServiceIndex = 10,
        InsertWarrantyCostPerMachine = 11,
