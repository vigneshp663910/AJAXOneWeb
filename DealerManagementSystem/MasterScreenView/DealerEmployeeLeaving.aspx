<%@ Page Title="" Language="C#" MasterPageFile="~/Dealer.Master" AutoEventWireup="true" CodeBehind="DealerEmployeeLeaving.aspx.cs" Inherits="DealerManagementSystem.MasterScreenView.DealerEmployeeLeaving" %>
                                    ...
                                    <asp:Panel ID="Panel1" runat="server">
                                        <div class="rf-p " id="txnHistory2:inputFiltersPanel2">
                                            <div class="rf-p-b " id="txnHistory2:inputFiltersPanel_body2">
                                                <table class="labeltxt fullWidth">
                                                    <tr>
                                                        <td>
                                                            <div class="tbl-row-right">
                                                                <div class="tbl-col-left">
                                                                    <asp:Label ID="Label2" runat="server" CssClass="label" Text="Wish To Leave"></asp:Label>
                                                                </div>
                                                                <div class="tbl-col-right">
                                                                    <asp:DropDownList ID="ddlWishToLeave" runat="server" CssClass="TextBox" Width="250px">
                                                        ...
                                                        <td>
                                                            <div class="tbl-row-right">
                                                                <div class="tbl-col-left">
                                                                    <asp:Label ID="Label31" runat="server" CssClass="label" Text="Date of Leaving"></asp:Label>
                                                                </div>
                                                                <div class="tbl-col-right">
                                                                    <asp:TextBox ID="txtDateOfLeaving" runat="server" CssClass="input" AutoComplete="SP" onkeyup="return removeText('MainContent_txtDOB');"></asp:TextBox>
                                                ...
                                                <asp:Button ID="btnAssignRole" runat="server" Text="Update" CssClass="InputButton" UseSubmitBehavior="true" OnClientClick="return ConfirmCreate();" OnClick="btnAssignRole_Click" />
