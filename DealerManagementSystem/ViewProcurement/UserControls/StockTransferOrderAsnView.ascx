<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="StockTransferOrderAsnView.ascx.cs" Inherits="DealerManagementSystem.ViewProcurement.UserControls.StockTransferOrderAsnView" %>
