...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="col-md-12">
            ...
            <fieldset class="fieldset-border">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-2 col-sm-12">
                        ...
                        <asp:TextBox ID="txtInvoiceDateF" runat="server" CssClass="form-control" AutoComplete="Off"></asp:TextBox>
                    ...
                    <div class="col-md-2 col-sm-12">
                        ...
                        <asp:TextBox ID="txtInvoiceDateT" runat="server" CssClass="form-control" AutoComplete="Off"></asp:TextBox>
        ...
        <div class="col-md-12 Report">
            <fieldset class="fieldset-border">
                <legend style="background: none; color: #007bff; font-size: 17px;">PO Invoice Report</legend>
                <div class="col-md-12 Report">
                    <div class="boxHead">
