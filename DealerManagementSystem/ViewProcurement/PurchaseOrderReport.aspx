<%@ Page Title="" Language="C#" MasterPageFile="~/Dealer.Master" AutoEventWireup="true" CodeBehind="PurchaseOrderReport.aspx.cs" Inherits="DealerManagementSystem.ViewProcurement.PurchaseOrderReport" %>
                ...
                <asp:Panel ID="Panel2" runat="server">
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-12">
                                <asp:Label ID="Label8" runat="server" CssClass="label" Text="PO Date To"></asp:Label>
                            ...
                            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-12">
                                ...
                                <asp:ListBox ID="lbStatus" runat="server" SelectionMode="Multiple" Height="130px">
                                    ...
                                    <asp:ListItem Value="3">PARTIAL_RECEIVED</asp:ListItem>
                                    <asp:ListItem Value="4">PARTIAL_CLOSE</asp:ListItem>
                                    <asp:ListItem Value="5">COMPLETED</asp:ListItem>
                                    <asp:ListItem Value="6">CLOSED</asp:ListItem>
                                    <asp:ListItem Value="7">ORDER_PLACED</asp:ListItem>
                                    <asp:ListItem Value="8">REJECTED</asp:ListItem>
                                    <asp:ListItem Value="9">TEMPLATE</asp:ListItem>
                                    <asp:ListItem Value="10">FORCE_CLOSED</asp:ListItem>
                                    <asp:ListItem Value="11">CANCELLED</asp:ListItem> 
                                    <asp:ListItem Value="12">AUTO PO STOCK DRAFT</asp:ListItem> 
                                </asp:ListBox>
                            </div>
