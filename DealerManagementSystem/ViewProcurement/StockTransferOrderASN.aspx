<%@ Page Title="" Language="C#" MasterPageFile="~/Dealer.Master" AutoEventWireup="true" CodeBehind="StockTransferOrderASN.aspx.cs" Inherits="DealerManagementSystem.ViewProcurement.StockTransferOrderASN" %>

<%@ Register Src="~/ViewProcurement/UserControls/StockTransferOrderAsnView.ascx" TagPrefix="UC" TagName="UC_StockTransferOrderAsnView" %> 
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="col-md-12">
            ...
            <fieldset class="fieldset-border">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-12 text-center">
                        ...
                        <asp:Button ID="btnExportExcelDetails" runat="server" Text="Export STO ASN Details" CssClass="btn Search" UseSubmitBehavior="true" OnClick="btnExportExcelDetails_Click" Width="170px" />
                    </div>
                </div>
            </fieldset>
            <div class="col-md-12">
                <div class="col-md-12 Report">
                    <fieldset class="fieldset-border">
                        ...
                        <div class="col-md-12 Report">
                            ...
                            <asp:GridView ID="gvICTickets" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered table-condensed Grid" AllowPaging="true" PageSize="20" EmptyDataText="No Data Found">
                                <Columns>
                                    <asp:TemplateField>
                                        <ItemTemplate>
        ...
        <div class="col-md-12" id="divDetailsView" runat="server" visible="false" style="padding: 5px 15px">
            ...
            <UC:UC_StockTransferOrderAsnView ID="UC_StockTransferOrderAsnView" runat="server"></UC:UC_StockTransferOrderAsnView>
        </div>
    </div>
</asp:Content>
