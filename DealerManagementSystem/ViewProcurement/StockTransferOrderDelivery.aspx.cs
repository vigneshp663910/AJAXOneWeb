...
{
    public partial class StockTransferOrderDelivery : BasePage
    {
        ...
        {
            Page.ClientScript.RegisterStartupScript(this.GetType(), "Script1", "<script type='text/javascript'>SetScreenTitle('Procurement » Stock Transfer Order Delivery');</script>");
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                FillStockTransferOrderForDelivery();
            }
            catch (Exception e1)
            {
        ...
        void FillStockTransferOrderForDelivery()
        {
            try
            {
                TraceLogger.Log(DateTime.Now);
                Search();
                PApiResult Result = new BStockTransferOrder().GetStockTransferOrderForDelivery(DealerID, OfficeID, StockTransferOrderNo, DateFrom, DateTo, StatusID, PageIndex, gvICTickets.PageSize);
...
//protected void Page_Load(object sender, EventArgs e)
//{
//    Page.ClientScript.RegisterStartupScript(this.GetType(), "Script1", "<script type='text/javascript'>SetScreenTitle('Procurement » STO Delivery');</script>");
//    lblMessage.Visible = false;
//    if (!IsPostBack)
//    {
//        PageCount = 0;
...
//    catch (Exception e1)
//    {
//        new FileLogger().LogMessage("StockTransferOrderDelivery", "fillStockTransferOrderDelivery", e1);
//        throw e1;
//    }
//}
//protected void ibtnArrowLeft_Click(object sender, ImageClickEventArgs e)
