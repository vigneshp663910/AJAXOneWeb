<%@ Page Title="" Language="C#" MasterPageFile="~/Dealer.Master" AutoEventWireup="true" CodeBehind="MonthlyProcurement.aspx.cs" Inherits="DealerManagementSystem.ViewProcurement.MonthlyProcurement" %>
                        ...
                        <div class="rf-p-b " id="txnHistory:j_idt1289_body">
                            ...
                            <table id="txnHistory1:panelGridid" style="height: 100%; width: 100%">
                                <tr>
                                    <td>
                                        <div class="boxHead">
                                            <div class="logheading">Filter : Sales Order Performance</div>
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="Label3" runat="server" CssClass="label" Text="Order Type"></asp:Label></td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="Label12" runat="server" CssClass="label" Text="Status"></asp:Label></td>
                                    <td>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Label ID="Label4" runat="server" CssClass="label" Text="PO Date From "></asp:Label></td>
                                        <td>
                                            <asp:TextBox ID="txtPoDateFrom" runat="server" CssClass="hasDatepicker"></asp:TextBox>
                                        ...
                                        <td>
                                            <asp:Label ID="Label5" runat="server" CssClass="label" Text="PO Date To"></asp:Label>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtPoDateTo" runat="server" CssClass="hasDatepicker"></asp:TextBox>
                            ...
                            <td>
                                <span id="txnHistory1:refreshDataGroup">
                                    ...
                                    <div style="background-color: white">
                                        <asp:GridView ID="gvICTickets" runat="server" AutoGenerateColumns="false" CssClass="TableGrid" Width="100%" AllowPaging="true" PageSize="20"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Period" HeaderStyle-Width="62px">
                                                    <ItemStyle VerticalAlign="Middle" HorizontalAlign="Center" />
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblPeriod" Text='<%# DataBinder.Eval(Container.DataItem, "POMonth")%>' runat="server" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField HeaderText="No. of Orders" HeaderStyle-Width="62px">
                                                    <ItemStyle VerticalAlign="Middle" HorizontalAlign="Center" />
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblPurchaseOrderID" Text='<%# DataBinder.Eval(Container.DataItem, "HeaderCount")%>' runat="server" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="No. of Items" HeaderStyle-Width="62px">
                                                    <ItemStyle VerticalAlign="Middle" HorizontalAlign="Center" />
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblPurchaseOrderID" Text='<%# DataBinder.Eval(Container.DataItem, "PurchaseOrderItem.ItemCount")%>' runat="server" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
