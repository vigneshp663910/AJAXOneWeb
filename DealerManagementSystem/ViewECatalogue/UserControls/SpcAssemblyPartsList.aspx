<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SpcAssemblyPartsList.aspx.cs" Inherits="DealerManagementSystem.ViewECatalogue.UserControls.SpcAssemblyPartsList" %>
...
<body style="background: white">
    ...
    <form id="form1" runat="server">
        <div id="w3mainclass" class="w3-main">
            <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <div class="action-btn" style="margin-top: 0px;">
                        <div class="" id="boxHere"></div>
                        <div class="dropdown btnactions" id="customerAction" style="right: 73px;top: 0px;">
                            <div class="btn Approval" style="width: 50px;height: 10px;">Actions</div>
                ...
                <div class="col-md-12 field-margin-top">
                    <div class="col-md-12">
                        <div class="col-md-12 Report">
                            ...
                            <asp:GridView ID="gvParts" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered table-condensed Grid" Width="800px" ShowFooter="false">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="SNo" HeaderStyle-Width="31px">
                                        <ItemStyle VerticalAlign="Middle" HorizontalAlign="Center" />
                                        <ItemTemplate>
                                        ...
                                        <FooterTemplate>
                                            <asp:TextBox ID="txtNumberF" runat="server" CssClass="form-control" BorderColor="Silver" AutoCompleteType="Disabled"></asp:TextBox>
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Alt" HeaderStyle-Width="25px">
                                        <ItemStyle VerticalAlign="Middle" HorizontalAlign="Left" />
                                        <ItemTemplate>
                                            <asp:Label ID="lblFlag" Text='<%# DataBinder.Eval(Container.DataItem, "Flag")%>' runat="server"></asp:Label>
                                        </ItemTemplate>
                                        <FooterTemplate>
                                            <asp:TextBox ID="txtFlagF" runat="server" CssClass="form-control" BorderColor="Silver" AutoCompleteType="Disabled"></asp:TextBox>
                                        </FooterTemplate>
                                    </asp:TemplateField>
                          ...
                          <asp:TemplateField HeaderText="Assy Code">
                                <ItemStyle VerticalAlign="Middle" HorizontalAlign="Left" />
                                <ItemTemplate>
                                    <asp:Label ID="lblMaterial" Text='<%# DataBinder.Eval(Container.DataItem, "Material.Material")%>' runat="server"></asp:Label>
                                </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Part No">
                                        ...
                                        <FooterTemplate>
                                            <asp:TextBox ID="txtPartF" runat="server" CssClass="form-control" BorderColor="Silver" AutoCompleteType="Disabled"></asp:TextBox>
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Description" HeaderStyle-Width="300px">
                                        <ItemStyle VerticalAlign="Middle" HorizontalAlign="Left" />
                                        <ItemTemplate>
                                            <asp:Label ID="lblMaterialDescription" Text='<%# DataBinder.Eval(Container.DataItem, "Material.MaterialDescription")%>' runat="server" Font-Size="11px"></asp:Label>
                                        </ItemTemplate>
                                        <FooterTemplate>
                                            <asp:TextBox ID="txtPartDescriptionF" runat="server" CssClass="form-control" BorderColor="Silver" AutoCompleteType="Disabled"></asp:TextBox>
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Part Qty" HeaderStyle-Width="37px">
                                        <ItemStyle VerticalAlign="Middle" HorizontalAlign="Left" />
                                        <ItemTemplate>
                                            <asp:Label ID="lblQty" Text='<%# DataBinder.Eval(Container.DataItem, "Qty")%>' runat="server"></asp:Label>
                                        </ItemTemplate>
                                        <FooterTemplate>
                                            <asp:TextBox ID="txtQtyF" runat="server" CssClass="form-control" BorderColor="Silver" AutoCompleteType="Disabled"></asp:TextBox>
                                        </FooterTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="X Co-Ord" HeaderStyle-Width="38px">
                                    ...
                                    <asp:TemplateField HeaderText="Y Co-Ord" HeaderStyle-Width="40px">
                                        <ItemStyle VerticalAlign="Middle" HorizontalAlign="Right" />
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Remarks">
                                        ...
                                        <FooterTemplate>
                                            <asp:TextBox ID="txtRemarksF" runat="server" CssClass="form-control" BorderColor="Silver" AutoCompleteType="Disabled"></asp:TextBox>
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Edit" HeaderStyle-Width="60px" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                ...
                <asp:Panel ID="pnlSaveCoOrdinate" runat="server" CssClass="Popup" Style="display: none">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="model-scroll">
                            <div class="col-md-12">
                                <asp:GridView ID="gvPartsCoordinats" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered table-condensed Grid" ClientIDMode="Static">
                                    <Columns>
        ...
        <asp:Panel ID="pnlAddPart" runat="server" CssClass="Popup" Style="display: none;">
            <div class="PopupHeader clearfix">
                <span id="PopupDialogue">Add / Edit Parts</span><a href="#" class="ui-dialog-titlebar-close ui-corner-all" role="button">
        ...
        <script type="text/javascript">
            ...
            function selectOnlyOne(radio) {
                ...
                for (var i = 0; i < rowCount; i++) {
                    var radios = document.getElementById('gvParts_rbParts_' + i);
