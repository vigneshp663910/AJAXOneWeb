<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ICTicketTransactionStatics.ascx.cs" Inherits="DealerManagementSystem.Dashboard.ICTicketTransactionStatics" %>
