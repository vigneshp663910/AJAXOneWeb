<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UserAccessByChildModule.ascx.cs" Inherits="DealerManagementSystem.ViewAdmin.UserControls.UserAccessByChildModule" %>
                        ...
                        <asp:GridView ID="gvUsers" runat="server" Width="100%" AutoGenerateColumns="false" CssClass="table table-bordered table-condensed Grid"   EmptyDataText="No Data Found">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="IsActive">
                                    ...
                                    <ItemTemplate>
                                        <asp:CheckBox ID="ChkIsActive" runat="server" Checked='<%# DataBinder.Eval(Container.DataItem, "IsActive")%>' Height="2px" Width="2px" Font-Size="XX-Small" />
