...
{
    public partial class UserAccessBySubModule : System.Web.UI.UserControl
    {
        ...
        private void FillGrid()
        {
            try
            {
                ...
                bool? IsActive = null;
                int SubModuleMasterID = Convert.ToInt32(ddlSubModule.SelectedValue);
                ...
                PApiResult Result = new BUser().GetUserAccessBySubModule(SubModuleMasterID, DealerID, DepartmentID, DesignationID, IsActive);
        ...
        protected void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Access.Add(Convert.ToInt32(ddlSubModule.SelectedValue), Userlist);
                PApiResult result = new BUser().InsertOrUpdateUserModuleAccess(Access);
