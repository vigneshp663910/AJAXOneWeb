<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UserAccessBySubModule.ascx.cs" Inherits="DealerManagementSystem.ViewAdmin.UserControls.UserAccessBySubModule" %>
