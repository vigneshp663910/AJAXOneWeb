<%@ Page Title="" Language="C#" MasterPageFile="~/ViewSalesTouchPoint/SalesTouchPointMaster.Master" AutoEventWireup="true" CodeBehind="Enquiry.aspx.cs" Inherits="DealerManagementSystem.ViewSalesTouchPoint.Enquiry" %>
<%@ Register Src="~/ViewSalesTouchPoint/UserControls/ViewEnquiry.ascx" TagPrefix="UC" TagName="UC_EnquiryView" %>
            ...
            <fieldset class="fieldset-border">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-12 text-center">
                        ...
                        <asp:Button ID="btnExportExcel" runat="server" Text="<%$ Resources:Resource, btnExportExcel %>" CssClass="btn Search" UseSubmitBehavior="true" OnClick="btnExportExcel_Click" Width="100px" visible="false"/>
                    </div>
                </div>
            </fieldset>
            <div class="col-md-12">
