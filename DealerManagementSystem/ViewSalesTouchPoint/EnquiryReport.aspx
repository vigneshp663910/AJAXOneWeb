<%@ Page Title="" Language="C#" MasterPageFile="~/ViewSalesTouchPoint/SalesTouchPointMaster.Master" AutoEventWireup="true" CodeBehind="EnquiryReport.aspx.cs" Inherits="DealerManagementSystem.ViewSalesTouchPoint.EnquiryReport" %>
                        ...
                        <div class="col-md-12 Report">
                            ...
                            <asp:GridView ID="gvEnquiry" CssClass="table table-bordered table-condensed Grid" AllowPaging="true" PageSize="5" runat="server" EmptyDataText="No Data Found"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="STP Enquiry">
                                        <ItemStyle VerticalAlign="Middle" />
                                        <ItemTemplate>
                                            <asp:Label ID="lblSTPEnquiryNumber" Text='<%# DataBinder.Eval(Container.DataItem, "SalesTouchPointEnquiryNumber")%>' runat="server" />
                                            <br />
                                            <asp:Label ID="lblSTPEnquiryDate" Text='<%# DataBinder.Eval(Container.DataItem, "SalesTouchPointEnquiryDate","{0:d}")%>' runat="server" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Quotation">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <br />
                                            <asp:Label ID="lblQuotationDate" Text='<%# DataBinder.Eval(Container.DataItem, "QuotationDate","{0:d}")%>' runat="server" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Invoice">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <br />
                                            <asp:Label ID="lblInvoiceDate" Text='<%# DataBinder.Eval(Container.DataItem, "InvoiceDate","{0:d}")%>' runat="server" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:BoundField HeaderText="Lead Status" DataField="LeadStatus.Status"></asp:BoundField>
                                </Columns>
