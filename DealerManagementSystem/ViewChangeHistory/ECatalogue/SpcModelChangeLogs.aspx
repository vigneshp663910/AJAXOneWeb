<%@ Page Title="" Language="C#" MasterPageFile="~/Dealer.Master" AutoEventWireup="true" CodeBehind="SpcModelChangeLogs.aspx.cs" Inherits="DealerManagementSystem.ViewChangeHistory.ECatalogue.SpcModelChangeLogs" %>
        ...
        <fieldset class="fieldset-border">
            ...
            <div class="col-md-12">
                <div class="col-md-2 text-left">
                    <label>SpcModel Code</label>
                    <asp:TextBox ID="txtSpcModelCode" runat="server" CssClass="form-control"></asp:TextBox>
                </div>
                <div class="col-md-2 text-left">
        ...
        <div class="col-md-12 Report">
            <fieldset class="fieldset-border">
                ...
                <div class="col-md-12 Report">
                    ...
                    <asp:GridView ID="gvSpcModelChangeLogs" runat="server" Width="100%" CssClass="table table-bordered table-condensed Grid"
