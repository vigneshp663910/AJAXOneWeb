<%@ Page Title="" Language="C#" MasterPageFile="~/Dealer.Master" AutoEventWireup="true" CodeBehind="SpcAssemblyChangeLogs.aspx.cs" Inherits="DealerManagementSystem.ViewChangeHistory.ECatalogue.SpcAssemblyChangeLogs" %>
        ...
        <fieldset class="fieldset-border">
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-2 text-left">
                    ...
                    <asp:DropDownList ID="ddlProductModel" runat="server" CssClass="form-control"/>
                </div>
                <div class="col-md-2 text-left">
                    <label>Assembly Code</label>
                    <asp:TextBox ID="txtAssemblyCode" runat="server" CssClass="form-control"></asp:TextBox>
                </div>
                <div class="col-md-2 text-left">
        ...
        <div class="col-md-12 Report">
            <fieldset class="fieldset-border">
                ...
                <div class="col-md-12 Report">
                    ...
                    <asp:GridView ID="gvSpcAssemblyLogs" runat="server" Width="100%" CssClass="table table-bordered table-condensed Grid"
