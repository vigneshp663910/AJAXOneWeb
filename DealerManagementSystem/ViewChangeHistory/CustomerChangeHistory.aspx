<%@ Page Title="" Language="C#" MasterPageFile="~/Dealer.Master" AutoEventWireup="true" CodeBehind="CustomerChangeHistory.aspx.cs" Inherits="DealerManagementSystem.ViewChangeHistory.CustomerChangeHistory" %>
            ...
            <div class="col-md-12">
               ...
               <%--     <asp:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender3" runat="server" TargetControlID="txtDateFrom" WatermarkText="DD/MM/YYYY"></asp:TextBoxWatermarkExtender>--%>
                ...
                <div class="col-md-2 text-left">
                    ...
                    <asp:DropDownList ID="ddlCustomerField" runat="server" CssClass="form-control" />

                </div>
                <div class="col-md-12 text-center">
                    <asp:Button ID="btnSearchCustChgHst" runat="server" Text="Retrieve" CssClass="btn Search" UseSubmitBehavior="true" OnClick="btnSearchCustChgHst_Click" OnClientClick="return dateValidation();" />
                    ...
                    <div class="boxHead">
                        <div class="logheading">
                            <div style="float: left">
                                <table>
                                    <tr>
                                        <td>Customer Change History:</td>
                                        <td>
                                            <asp:Label ID="lblRowCountCustChgHst" runat="server" CssClass="label"></asp:Label></td>
                                        <td>
                                            <asp:ImageButton ID="ibtnCustChgHstArrowLeft" runat="server" ImageUrl="~/Images/ArrowLeft.png" Width="15px" OnClick="ibtnCustChgHstArrowLeft_Click" /></td>
                                        <td>
                                            <asp:ImageButton ID="ibtnCustChgHstArrowRight" runat="server" ImageUrl="~/Images/ArrowRight.png" Width="15px" OnClick="ibtnCustChgHstArrowRight_Click" /></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                    </div>
                    <asp:GridView ID="gvCustChgHst" runat="server" Width="100%" CssClass="table table-bordered table-condensed Grid"
                        EmptyDataText="No Data Found" PageSize="10" AllowPaging="true" OnPageIndexChanging="gvCustChgHst_PageIndexChanging">
                        <Columns>
