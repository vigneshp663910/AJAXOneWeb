...
namespace DealerManagementSystem.ViewSales
{
    public partial class SalesCommissionClaimInvoiceVerify : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Page.ClientScript.RegisterStartupScript(this.GetType(), "Script1", "<script type='text/javascript'>SetScreenTitle('Sales » Commision » Claim Invoice Release');</script>");
        ...
        protected void btnExportExcel_Click(object sender, EventArgs e)
        {
            ...
            {
                new FileLogger().LogMessage("SalesCommissionClaimInvoiceVerify", "btnExportExcelForSAP_Click", ex);
            }
