                                            ...
                                            <div class="rf-p " id="txnHistory:inputFiltersPanel">
                                                <div class="rf-p-b " id="txnHistory:inputFiltersPanel_body">
                                                    <table class="labeltxt">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:Label ID="Label9" runat="server" CssClass="label" Text="Quotetion Number"></asp:Label></td>
                                                            <td>
                                                                <asp:TextBox ID="txtQuotetionNumber" runat="server" CssClass="input"></asp:TextBox>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:Label ID="Label12" runat="server" CssClass="label" Text="SO Status"></asp:Label></td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:Label ID="Label10" runat="server" CssClass="label" Text="Delivery Date From"></asp:Label></td>
                                                            <td>
                                                                <asp:TextBox ID="txtDeliveryDateFrom" runat="server" CssClass="input" AutoComplete="Off"></asp:TextBox>
                                                            ...
                                                            <td style="width: 20px"></td>
                                                            <td>
                                                                <asp:Label ID="Label11" runat="server" CssClass="label" Text="Delivery Date To"></asp:Label>
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtDeliveryDateTo" runat="server" CssClass="input" AutoComplete="Off"></asp:TextBox>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txtOrderDateFrom" runat="server" CssClass="input" AutoComplete="Off"></asp:TextBox>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txtOrderDateTo" runat="server" CssClass="input" AutoComplete="Off"></asp:TextBox>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:Label ID="Label13" runat="server" CssClass="label" Text="Sales Type"></asp:Label></td>
                                                            <td>
