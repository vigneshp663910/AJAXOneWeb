<%@ Page Title="" Language="C#" MasterPageFile="~/Dealer.Master" AutoEventWireup="true" CodeBehind="SalesInvoice.aspx.cs" Inherits="DealerManagementSystem.ViewSales.SalesInvoice" %>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <table>
                                                            <tr>
                                                                <td>
                                                                    <asp:Label ID="Label9" runat="server" CssClass="label" Text="Status (Use Shift or Ctrl key to select Multiple)"></asp:Label></td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <asp:ListBox ID="lbStatus" runat="server" SelectionMode="Multiple" Height="130px">
                                                                        <asp:ListItem Value="0">All</asp:ListItem>
                                                                        <asp:ListItem Value="PARTIAL_SETTLED">PARTIAL_SETTLED</asp:ListItem>
                            ...
                            <td>
                                <span id="txnHistory1:refreshDataGroup">
                                    ...
                                    <div style="background-color: white">
                                        ...
                                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" CssClass="TableGrid" Width="100%" AllowPaging="true" PageSize="20"
                                        ...
                                        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="false" CssClass="TableGrid" Width="100%" AllowPaging="true" PageSize="20"
