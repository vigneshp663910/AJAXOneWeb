        ...
        <div class="col-md-12">
            <fieldset class="fieldset-border">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-2">                
                         <asp:TextBox ID="txtCurrentPassword" runat="server" CssClass="form-control" Width="100%" />
                    </div>
                    <div class="col-md-7">
                    </div>
                    ...
                    <div class="col-md-2">           
                        <asp:TextBox ID="txtNewPassword" runat="server" CssClass="form-control" Width="100%" />
                    </div>
                    <div class="col-md-7">
                    </div>
                    ...
                    <div class="col-md-2">                     
                        <asp:TextBox ID="txtReTypeNewPassword" runat="server" CssClass="form-control" Width="100%" />
                    </div>
                    <div class="col-md-7">
