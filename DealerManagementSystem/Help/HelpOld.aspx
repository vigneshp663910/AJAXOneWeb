<%@ Page Title="" Language="C#" MasterPageFile="~/Dealer.Master" AutoEventWireup="true" CodeBehind="HelpOld.aspx.cs" Inherits="DealerManagementSystem.Help.HelpOld" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <table style="border-color: #CCCCCC; width: 1000px; font-family: Calibri; font-size: large; border-collapse: collapse;" border="2">
            ...
            <%--<tr style="background-color: #FFFFFF">
                ...
                <td align="center">
                    <asp:HyperLink ID="HyperLink1a" runat="server" NavigateUrl="https://youtu.be/w_2OvF-iq70"><asp:Image ID="Image1" runat="server" ImageUrl="~/Images/vplay.png"  width="40px" Height="25px" /></asp:HyperLink></td>
                <td align="center">
            ...
            <tr style="background-color: #FFFFFF">
                ...
                <td align="center">
                    <%--<asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="https://youtu.be/LUWU2OgrFns"><asp:Image ID="Image2" runat="server" ImageUrl="~/Images/vplay.png"  width="40px" Height="25px" /></asp:HyperLink>--%></td>
            </tr>
            <tr style="background-color: #FFFFFF">
                <td align="right">5</td>
                <td>Activities</td>
                ...
                <td align="center">
                    <%--<asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl="https://youtu.be/LUWU2OgrFns"><asp:Image ID="Image3" runat="server" ImageUrl="~/Images/vplay.png"  width="40px" Height="25px" /></asp:HyperLink>--%></td>
            </tr>
            <tr style="background-color: #FFFFFF">
                <td align="right">6</td>
                <td>Project</td>
                ...
                <td align="center">
                    <%--<asp:HyperLink ID="HyperLink4" runat="server" NavigateUrl="https://youtu.be/LUWU2OgrFns"><asp:Image ID="Image5" runat="server" ImageUrl="~/Images/vplay.png"  width="40px" Height="25px" /></asp:HyperLink>--%></td>
            </tr>
            <tr style="background-color: #FFFFFF">
                <td align="right">7</td>
                <td>Pre-Sales</td>
                <td align="center">
                    <asp:HyperLink ID="HyperLink6" runat="server" NavigateUrl="~/Help/HelpDoc.aspx?aFileName=../Help/Files/V1_AJAXOne.pdf"><asp:Image ID="Image6" runat="server" ImageUrl="~/Images/Preview.png" width="25px" Height="25px"/></asp:HyperLink></td>
                <td align="center">
                    <asp:HyperLink ID="HyperLink7" runat="server" NavigateUrl="Files/34_AJAXOne_Pre-Sales.pps"><asp:Image ID="Image8" runat="server" ImageUrl="~/Images/save.png"  width="25px" Height="25px" /></asp:HyperLink></td>
                <td align="center">
                    <%--<asp:HyperLink ID="HyperLink8" runat="server" NavigateUrl="https://youtu.be/TD8BX5yNyR0"><asp:Image ID="Image9" runat="server" ImageUrl="~/Images/vplay.png"  width="40px" Height="25px" /></asp:HyperLink>--%></td>
            </tr>
            <tr style="background-color: #FFFFFF">
                <td align="right"></td>
            ...
            <tr style="background-color: #FFFFFF">
                ...
                <td align="center">
                    <%--<asp:HyperLink ID="HyperLink9" runat="server" NavigateUrl="https://youtu.be/TD8BX5yNyR0"><asp:Image ID="Image10" runat="server" ImageUrl="~/Images/vplay.png"  width="40px" Height="25px" /></asp:HyperLink>--%></td>
            </tr>
            <tr style="background-color: #FFFFFF">
                <td align="right"></td>
                <td>e) Quotation</td>
                ...
                <td align="center">
                    <%--<asp:HyperLink ID="HyperLink10" runat="server" NavigateUrl="https://youtu.be/TD8BX5yNyR0"><asp:Image ID="Image11" runat="server" ImageUrl="~/Images/vplay.png"  width="40px" Height="25px" /></asp:HyperLink>--%></td>
            </tr>
            <tr style="background-color: #FFFFFF">
                <td align="right"></td>
                <td>f) Report</td>
                ...
                <td align="center">
                    <%--<asp:HyperLink ID="HyperLink12" runat="server" NavigateUrl="https://youtu.be/TD8BX5yNyR0"><asp:Image ID="Image13" runat="server" ImageUrl="~/Images/vplay.png"  width="40px" Height="25px" /></asp:HyperLink>--%></td>
            </tr>
            <tr style="background-color: #FFFFFF">
                <td align="right">8</td>
                <td>Task</td>
                ...
                <td align="center">
                    <%--<asp:HyperLink ID="HyperLink13" runat="server" NavigateUrl="https://youtu.be/qxj2HgGuDRY">
                        <asp:Image ID="Image14" runat="server" ImageUrl="~/Images/vplay.png" Width="40px" Height="25px" /></asp:HyperLink>--%></td>
            </tr>
            <tr style="background-color: #FFFFFF">
                <td align="right">9</td>
                <td>Dashboard</td>
                ...
                <td align="center">
                    <%--<asp:HyperLink ID="HyperLink15" runat="server" NavigateUrl="https://youtu.be/qxj2HgGuDRY">
                        <asp:Image ID="Image16" runat="server" ImageUrl="~/Images/vplay.png" Width="40px" Height="25px" /></asp:HyperLink>--%></td>
            </tr>
            <tr style="background-color: #FFFFFF">
                ...
                <td align="center">
                    <%--<asp:HyperLink ID="HyperLink16" runat="server" NavigateUrl="https://youtu.be/qxj2HgGuDRY">
                        <asp:Image ID="Image17" runat="server" ImageUrl="~/Images/vplay.png" Width="40px" Height="25px" /></asp:HyperLink>--%></td>
            </tr>            
        </table>
</asp:Content>
