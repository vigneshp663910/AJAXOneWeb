    ...
    public partial class DMSDynamic : System.Web.UI.MasterPage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                //lblusername.Text = PSession.User.ContactName+ Window.lo.;
        ...
        string ReMenu(List<PSubModuleAccess> SMs, string SubModuleName, string MenuDMS, [Optional] string MainMenu)
        {
            ...
            if (SMsCount.Count() == 0)
            {
                return MenuDMS + "<a href='Location.aspx' class='w3-bar-item w3-button' onclick=ParentMenuClick('" + SMs[0].ParentMenu.ToString() + "','" + MainMenu + "')>" + SMs[0].SubModuleName + "</a>";
            }
