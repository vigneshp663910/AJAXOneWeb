<%@ Page Title="" Language="C#" MasterPageFile="~/Dealer.Master" AutoEventWireup="true" CodeBehind="DealerEmployeeLeaving.aspx.cs" Inherits="DealerManagementSystem.ViewMaster.DealerEmployeeLeaving" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="col-md-12">
                ...
                <div class="col-md-12 Report">
                    ...
                    <asp:GridView ID="gvDealerEmployee" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-condensed Grid" AllowPaging="True" DataKeyNames="DealerEmployeeID" PageSize="20" OnPageIndexChanging="gvDealerEmployee_PageIndexChanging">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Dealer Name" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left">
                                <ItemTemplate>
        ...
        <div id="pnlAssingn" runat="server" visible="false">
            <div class="col-md-12">
                <fieldset class="fieldset-border">
                            ...
                            <asp:GridView ID="gvRole" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-condensed Grid">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Date Of Leaving">
                                        <ItemTemplate>
                                            <asp:Label ID="lblLeaving" Text='<%# DataBinder.Eval(Container.DataItem, "DateOfLeaving","{0:d}")%>' runat="server"></asp:Label>
                                        </ItemTemplate>
                                        <HeaderStyle Width="192px" />
                                        <ItemStyle VerticalAlign="Middle" HorizontalAlign="Center" />
                                    </asp:TemplateField>
                ...
                <fieldset class="fieldset-border">
                    ...
                    <div class="col-md-12">
                        <div class="col-md-3 text-right">
                            <label>Wish To Leave</label>
                        </div>
                        <div class="col-md-3">
                            <asp:DropDownList ID="ddlWishToLeave" runat="server" CssClass="form-control" Width="250px">
                        ...
                        <div class="col-md-3">
                            <asp:TextBox ID="txtDateOfLeaving" runat="server" CssClass="form-control" AutoComplete="SP" onkeyup="return removeText('MainContent_txtDOB');"></asp:TextBox>
                            <asp:CalendarExtender ID="caDateOfJoining" runat="server" TargetControlID="txtDateOfLeaving" PopupButtonID="txtDateOfLeaving" Format="dd/MM/yyyy"></asp:CalendarExtender>
                            <asp:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender1" runat="server" TargetControlID="txtDateOfLeaving" WatermarkText="DD/MM/YYYY"></asp:TextBoxWatermarkExtender>
                        </div>
                        <div class="col-md-12 text-center">
                            <asp:Button ID="btnAssignRole" runat="server" Text="Update" CssClass="InputButton btn Save" UseSubmitBehavior="true" OnClientClick="return ConfirmCreate();" OnClick="btnAssignRole_Click" />
