...
namespace DealerManagementSystem.ViewMaster
{
    ...
    {
        public List<PDMS_EquipmentHeader> Equip
        {
            get
            {
                if (Session["Customer"] == null)
                {
                    Session["Customer"] = new List<PDMS_EquipmentHeader>();
                }
                return (List<PDMS_EquipmentHeader>)Session["Customer"];
            }
            set
            {
        ...
        void CustBind()
        {
            ...
            lblRowCount.Text = (((gvEquipment.PageIndex) * gvEquipment.PageSize) + 1) 
                + " - " + (((gvEquipment.PageIndex) * gvEquipment.PageSize) + gvEquipment.Rows.Count) + " of " + Equip.Count;
        }
        ...
        void SearchEquipment()
        {
            ...
            Equip = new BDMS_Equipment().GetEquipment(null, null);
            gvEquipment.DataSource = Equip;
            gvEquipment.DataBind();
