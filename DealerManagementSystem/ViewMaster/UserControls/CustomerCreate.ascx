        ...
        <fieldset class="fieldset-border" id="Fieldset1" runat="server">
            <div class="col-md-12">
                ...
                <div class="col-md-6 col-sm-12">
                    <label class="modal-label">Title <samp style="color:red">*</samp></label>
                ...
                <div class="col-md-6 col-sm-12">
                    <label class="modal-label">Mobile <samp style="color:red">*</samp></label>
                ...
                <div class="col-md-6 col-sm-12">
                    <label class="modal-label">Alternative Mobile <samp style="color:red">*</samp></label>
                ...
                <div class="col-md-6 col-sm-12">
                    <label class="modal-label">Email <samp style="color:red">*</samp></label>
