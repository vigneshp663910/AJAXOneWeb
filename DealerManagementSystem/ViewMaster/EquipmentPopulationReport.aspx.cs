...
{
    public partial class EquipmentPopulationReport : BasePage
    {
      //  public override SubModule SubModuleName { get { return SubModule.ViewEquipment_EquipmentPopulationReport; } }
        public DataTable Equipment
        {
            get
            {
                if (Session["DMS_EquipmentPopulationReport"] == null)
                {
                    Session["DMS_EquipmentPopulationReport"] = new DataTable();
                }
                return (DataTable)Session["DMS_EquipmentPopulationReport"];
            }
            set
            {
                Session["DMS_EquipmentPopulationReport"] = value;
            }
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                new BDMS_Address().GetStateDDL(ddlState, null, null, null, "");
