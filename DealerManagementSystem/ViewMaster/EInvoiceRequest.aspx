            ...
            <div class="col-md-12">
                <div class="col-md-12 Report">
                    <fieldset class="fieldset-border">
                        ...
                        <asp:GridView ID="gvPayInvoice" runat="server" AutoGenerateColumns="false" Width="100%" OnRowDataBound="gvPayInvoice_RowDataBound" CssClass="table table-bordered table-condensed Grid" AllowPaging="true" PageSize="20" OnPageIndexChanging="gvPayInvoice_PageIndexChanging">
                            <Columns>
                                <asp:TemplateField HeaderText="Generat E-Invoice">
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <asp:Button ID="btnGeneratePayInvoice" runat="server" Text="Generate E-Invoice" CssClass="btn Search" UseSubmitBehavior="true" OnClick="btnGeneratePayInvoice_Click"  Width="150px" Height="25px" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <%--  <asp:TemplateField>
                                            <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Tax Scheme">
                                    <ItemStyle VerticalAlign="Middle" HorizontalAlign="Center" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblTax_Scheme" Text='<%# DataBinder.Eval(Container.DataItem, "TranDtls.TaxSch")%>' runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Document Category">
                                    <ItemStyle VerticalAlign="Middle" HorizontalAlign="Center" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblDocumentCategory" Text='<%# DataBinder.Eval(Container.DataItem, "TranDtls.SupTyp","{0:d}")%>' runat="server"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Document Type">
                                    <ItemStyle VerticalAlign="Middle" HorizontalAlign="Center" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblDocumentType" Text='<%# DataBinder.Eval(Container.DataItem, "DocDtls.Typ")%>' runat="server"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Billing Document">
                                    <ItemStyle VerticalAlign="Middle" HorizontalAlign="Left" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblBillingDocument" Text='<%# DataBinder.Eval(Container.DataItem, "DocDtls.No")%>' runat="server"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Invoice Date">
                                    <ItemStyle VerticalAlign="Middle" HorizontalAlign="Right" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblInvoiceDate" Text='<%# DataBinder.Eval(Container.DataItem, "DocDtls.Dt","{0:n}")%>' runat="server"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Supplier GSTIN">
                                    <ItemStyle VerticalAlign="Middle" HorizontalAlign="Right" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblSupplierGSTIN" Text='<%# DataBinder.Eval(Container.DataItem, "SellerDtls.Gstin")%>' runat="server"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Supplier Trade Name">
                                    <ItemStyle VerticalAlign="Middle" HorizontalAlign="Right" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblSupplierTrade_Name" Text='<%# DataBinder.Eval(Container.DataItem, "SellerDtls.LglNm")%>' runat="server"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Supplier addr1">
                                    <ItemStyle VerticalAlign="Middle" HorizontalAlign="Right" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblSupplier_addr1" Text='<%# DataBinder.Eval(Container.DataItem, "SellerDtls.Addr1")%>' runat="server"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Supplier Location">
                                    <ItemStyle VerticalAlign="Middle" HorizontalAlign="Right" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblSupplierLocation" Text='<%# DataBinder.Eval(Container.DataItem, "SellerDtls.Loc")%>' runat="server"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Supplier Pincode">
                                    <ItemStyle VerticalAlign="Middle" HorizontalAlign="Right" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblSupplierPincode" Text='<%# DataBinder.Eval(Container.DataItem, "SellerDtls.Pin")%>' runat="server"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Supplier State Code">
                                    <ItemStyle VerticalAlign="Middle" HorizontalAlign="Right" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblSupplierStateCode" Text='<%# DataBinder.Eval(Container.DataItem, "SellerDtls.Stcd")%>' runat="server"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Buyer GSTIN">
                                    <ItemStyle VerticalAlign="Middle" HorizontalAlign="Right" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblBuyerGSTIN" Text='<%# DataBinder.Eval(Container.DataItem, "BuyerDtls.Gstin")%>' runat="server"></asp:Label>
                                        <asp:TextBox ID="txtBuyerGSTIN" runat="server" CssClass="input" Text='<%# DataBinder.Eval(Container.DataItem, "BuyerDtls.Gstin")%>' Visible="false" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Buyer Name">
                                    <ItemStyle VerticalAlign="Middle" HorizontalAlign="Right" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblBuyerName" Text='<%# DataBinder.Eval(Container.DataItem, "BuyerDtls.LglNm")%>' runat="server"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Buyer State Code">
                                    <ItemStyle VerticalAlign="Middle" HorizontalAlign="Right" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblBuyerStateCode" Text='<%# DataBinder.Eval(Container.DataItem, "BuyerDtls.Stcd")%>' runat="server"></asp:Label>
                                        <asp:TextBox ID="txtBuyerStateCode" runat="server" CssClass="input" Text='<%# DataBinder.Eval(Container.DataItem, "BuyerDtls.Stcd")%>' Visible="false" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Buyer Addr1">
                                    <ItemStyle VerticalAlign="Middle" HorizontalAlign="Right" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblBuyer_addr1" Text='<%# DataBinder.Eval(Container.DataItem, "BuyerDtls.Addr1")%>' runat="server"></asp:Label>
                                        <asp:TextBox ID="txtBuyer_addr1" runat="server" CssClass="input" Text='<%# DataBinder.Eval(Container.DataItem, "BuyerDtls.Addr1")%>' Visible="false" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Buyer Loc">
                                    <ItemStyle VerticalAlign="Middle" HorizontalAlign="Right" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblBuyer_loc" Text='<%# DataBinder.Eval(Container.DataItem, "BuyerDtls.Loc")%>' runat="server"></asp:Label>
                                        <asp:TextBox ID="txtBuyer_loc" runat="server" CssClass="input" Text='<%# DataBinder.Eval(Container.DataItem, "BuyerDtls.Loc")%>' Visible="false" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Buyer Pincode">
                                    <ItemStyle VerticalAlign="Middle" HorizontalAlign="Right" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblBuyerPincode" Text='<%# DataBinder.Eval(Container.DataItem, "BuyerDtls.Pin")%>' runat="server"></asp:Label>
                                        <asp:TextBox ID="txtBuyerPincode" runat="server" CssClass="input" Text='<%# DataBinder.Eval(Container.DataItem, "BuyerDtls.Pin")%>' Visible="false" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Disp Sup Trade Name">
                                    <ItemStyle VerticalAlign="Middle" HorizontalAlign="Right" />
                                    <ItemTemplate>
                                        <asp:Label ID="lbldisp_sup_trade_Name" Text='<%# DataBinder.Eval(Container.DataItem, "DispDtls.Nm")%>' runat="server"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Disp Sup Addr1">
                                    <ItemStyle VerticalAlign="Middle" HorizontalAlign="Right" />
                                    <ItemTemplate>
                                        <asp:Label ID="lbldisp_sup_addr1" Text='<%# DataBinder.Eval(Container.DataItem, "DispDtls.Addr1")%>' runat="server"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Disp Sup Loc">
                                    <ItemStyle VerticalAlign="Middle" HorizontalAlign="Right" />
                                    <ItemTemplate>
                                        <asp:Label ID="lbldisp_sup_loc" Text='<%# DataBinder.Eval(Container.DataItem, "DispDtls.Loc")%>' runat="server"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Disp Sup Pin">
                                    <ItemStyle VerticalAlign="Middle" HorizontalAlign="Right" />
                                    <ItemTemplate>
                                        <asp:Label ID="lbldisp_sup_pin" Text='<%# DataBinder.Eval(Container.DataItem, "DispDtls.Pin")%>' runat="server"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Disp Sup Stcd">
                                    <ItemStyle VerticalAlign="Middle" HorizontalAlign="Right" />
                                    <ItemTemplate>
                                        <asp:Label ID="lbldisp_sup_stcd" Text='<%# DataBinder.Eval(Container.DataItem, "DispDtls.Stcd")%>' runat="server"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Accumulated Ass Total Amount">
                                    <ItemStyle VerticalAlign="Middle" HorizontalAlign="Right" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblAccumulatedAssTotalAmount" Text='<%# DataBinder.Eval(Container.DataItem, "ValDtls.AssVal")%>' runat="server"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Accumulated Sgst Val">
                                    <ItemStyle VerticalAlign="Middle" HorizontalAlign="Right" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblAccumulatedSgstVal" Text='<%# DataBinder.Eval(Container.DataItem, "ValDtls.SgstVal")%>' runat="server"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Accumulated Igst Val">
                                    <ItemStyle VerticalAlign="Middle" HorizontalAlign="Right" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblAccumulatedIgstVal" Text='<%# DataBinder.Eval(Container.DataItem, "ValDtls.IgstVal")%>' runat="server"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Accumulated Cgst Val">
                                    <ItemStyle VerticalAlign="Middle" HorizontalAlign="Right" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblAccumulatedCgstVal" Text='<%# DataBinder.Eval(Container.DataItem, "ValDtls.CgstVal")%>' runat="server"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Accumulated Ces Val">
                                    <ItemStyle VerticalAlign="Middle" HorizontalAlign="Right" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblAccumulatedCesVal" Text='<%# DataBinder.Eval(Container.DataItem, "ValDtls.CesVal")%>' runat="server"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Accumulated St Ces Val">
                                    <ItemStyle VerticalAlign="Middle" HorizontalAlign="Right" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblAccumulatedStCesVal" Text='<%# DataBinder.Eval(Container.DataItem, "ValDtls.StCesVal")%>' runat="server"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Accumulated Discount">
                                    <ItemStyle VerticalAlign="Middle" HorizontalAlign="Right" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblTotDiscount" Text='<%# DataBinder.Eval(Container.DataItem, "ValDtls.Discount")%>' runat="server"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Accumulated OthChrg">
                                    <ItemStyle VerticalAlign="Middle" HorizontalAlign="Right" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblTotOthChrg" Text='<%# DataBinder.Eval(Container.DataItem, "ValDtls.OthChrg")%>' runat="server"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="RndOffAmt">
                                    <ItemStyle VerticalAlign="Middle" HorizontalAlign="Right" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblRndOffAmt" Text='<%# DataBinder.Eval(Container.DataItem, "ValDtls.RndOffAmt")%>' runat="server"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="TotInvVal">
                                    <ItemStyle VerticalAlign="Middle" HorizontalAlign="Right" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblTotInvVal" Text='<%# DataBinder.Eval(Container.DataItem, "ValDtls.TotInvVal")%>' runat="server"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="TotInvValFc">
                                    <ItemStyle VerticalAlign="Middle" HorizontalAlign="Right" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblTotInvValFc" Text='<%# DataBinder.Eval(Container.DataItem, "ValDtls.TotInvValFc")%>' runat="server"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                       ...
                                       <%-- <asp:Button ID="btnEdit" runat="server" Text="Edit" Visible="false" OnClick="btnEdit_Click"  CssClass="btn Search"  Width="75px" Height="25px"/>
                                        ...
                                        <tr>
                                            <td colspan="100%" style="padding-left: 96px">
                                                <div id="EInvoiceID-<%# Eval("DocDtls.No") %>" style="display: block; position: relative;">
             ...
             <div class="col-md-12">
                <div class="col-md-12 Report">
                    <fieldset class="fieldset-border">
                        ...
                        <div class="boxHead">
                            <div class="logheading">
                                <div style="float: left">
                                    <table>
                                        <tr>
                                            <td>Marketing Invoice(s):</td>
                                            <td>
                                                <asp:Label ID="lblMarketingInvoice" runat="server" CssClass="label"></asp:Label></td>
                                           </tr>
                                    </table>
                                </div>
                            </div>
                        ...
                        <asp:GridView ID="gvMarketingInv" runat="server" AutoGenerateColumns="false" Width="100%" OnRowDataBound="gvMarketingInv_RowDataBound" CssClass="table table-bordered table-condensed Grid" AllowPaging="true" PageSize="20" OnPageIndexChanging="gvMarketingInv_PageIndexChanging">
                            <Columns>
                                <asp:TemplateField HeaderText="Generat E-Invoice">
                                    <ItemStyle VerticalAlign="Middle" HorizontalAlign="Center" />
                                    <ItemTemplate>
                                        <%-- <asp:CheckBox ID="cbChecked" runat="server" Checked='<%# DataBinder.Eval(Container.DataItem, "Checked")%>' />--%>
                                        <asp:Button ID="btnGenerateInvoice" runat="server" Text="Generate E-Invoice" CssClass="btn Search" UseSubmitBehavior="true" OnClick="btnGeneratePayInvoice_Click"  Width="150px" Height="25px" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <%--  <asp:TemplateField>
                                            <ItemTemplate>
