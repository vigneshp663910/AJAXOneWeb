<%@ Page Title="" Language="C#" MasterPageFile="~/Dealer.Master" AutoEventWireup="true" CodeBehind="WarrantyClaimApprovalLevel1.aspx.cs" Inherits="DealerManagementSystem.ViewService.WarrantyClaimApprovalLevel1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="col-md-12">
            ...
            <fieldset class="fieldset-border">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-6 text-left">
                        <asp:Label ID="lblStatus" runat="server" CssClass="label" Text="Status" Font-Bold="true"></asp:Label><br />
        ...
        <div class="col-md-12 Report">
            <fieldset class="fieldset-border">
                <legend style="background: none; color: #007bff; font-size: 17px;">Claim Approval</legend>
                <div class="col-md-12 Report">
                    <div class="boxHead">
                    ...
                    <asp:GridView ID="gvICTickets" runat="server" AutoGenerateColumns="false" Width="100%" DataKeyNames="InvoiceNumber" OnRowDataBound="gvICTickets_RowDataBound" CssClass="table table-bordered table-condensed Grid" AllowPaging="true" PageSize="10" OnPageIndexChanging="gvICTickets_PageIndexChanging">
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Apr.1 By" HeaderStyle-Width="55px">
                                <ItemStyle VerticalAlign="Middle" HorizontalAlign="Center" />
                                <ItemTemplate>
                                    <asp:Button ID="btnApproved1By" runat="server" Text="Approve" CssClass="btn Approval" UseSubmitBehavior="true" Visible="false" OnClick="btnApproved1By_Click" style="height:33px;width:80px;"/>
                            ...
                            <asp:TemplateField HeaderText="Apr.2 By" HeaderStyle-Width="55px">
                                <ItemStyle VerticalAlign="Middle" HorizontalAlign="Center" />
                                <ItemTemplate>
                                    <asp:Button ID="btnApproved2By" runat="server" Text="Approve" CssClass="btn Approval" UseSubmitBehavior="true" Visible="false" OnClick="btnApproved2By_Click" style="height:33px;width:80px;"/>
                            ...
                            <asp:TemplateField HeaderText="Apr.3 By" HeaderStyle-Width="55px">
                                <ItemStyle VerticalAlign="Middle" HorizontalAlign="Center" />
                                <ItemTemplate>
                                    <asp:Button ID="btnApproved3By" runat="server" Text="Approve" CssClass="btn Approval" UseSubmitBehavior="true" Visible="false" OnClick="btnApproved3By_Click" style="height:33px;width:80px;"/>
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Apr. 1 Amt" HeaderStyle-Width="55px">
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:TextBox ID="txtApproved1Amount" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Approved1Amount")%>' CssClass="form-control" BorderColor="Silver" Width="70px" Enabled="false" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Apr. 1 Remarks" HeaderStyle-Width="55px">
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:DropDownList ID="ddlApproved1Remarks" runat="server" CssClass="form-control" BorderColor="Silver" Visible="false" Width="100px" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Failure Mat Remarks 2" HeaderStyle-Width="150px">
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:DropDownList ID="ddlMaterialStatusRemarks2" runat="server" CssClass="form-control" BorderColor="Silver" Visible="false" Width="100px" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Apr 2 Amt" HeaderStyle-Width="55px">
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:TextBox ID="txtApproved2Amount" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Approved2Amount")%>' CssClass="form-control" BorderColor="Silver" Width="70px" Enabled="false" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Apr. 2 Remarks" HeaderStyle-Width="55px">
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:DropDownList ID="ddlApproved2Remarks" runat="server" CssClass="form-control" BorderColor="Silver" Visible="false" Width="100px" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Apr 3 Amt" HeaderStyle-Width="55px">
                                                            <ItemStyle VerticalAlign="Middle" HorizontalAlign="Center" />
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtApproved3Amount" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Approved3Amount")%>' CssClass="form-control" BorderColor="Silver" Width="70px" Enabled="false" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Apr. 3 Remarks" HeaderStyle-Width="55px">
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:DropDownList ID="ddlApproved3Remarks" runat="server" CssClass="form-control" BorderColor="Silver" Visible="false" Width="100px" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
