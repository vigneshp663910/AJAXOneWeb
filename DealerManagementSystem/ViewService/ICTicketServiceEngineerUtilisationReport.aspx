    ...
    <div class="col-md-12">
        ...
        <div class="col-md-12 Report">
            <fieldset class="fieldset-border">
                ...
                <div class="col-md-12 Report" id="divUtilisationReportDetails" runat="server" visible="false">
                    <table>
                        <tr>
                            <td>
                                <asp:Label ID="lblURD1Codunt" runat="server" Text="" CssClass="label" Width="100%" />
                                <asp:Button ID="btnExportURD1" runat="server" Text="<%$ Resources:Resource, btnExportExcel %>" CssClass="btn Back" UseSubmitBehavior="true" OnClick="btnExportURD1_Click" Width="100px" />
                            </td>
                        </tr>
                    </table>
                    <asp:GridView ID="gvURD1" runat="server" CssClass="table table-bordered table-condensed Grid" AllowPaging="true" PageSize="30" OnPageIndexChanging="gvURD1_PageIndexChanging">
                        <AlternatingRowStyle BackColor="#ffffff" />
                        <FooterStyle ForeColor="White" />
                        <HeaderStyle Font-Bold="True" ForeColor="White" HorizontalAlign="Left" />
                        <PagerStyle Font-Bold="True" ForeColor="White" HorizontalAlign="Center" />
                    ...
                    <table>
                        <tr>
                            <td>
                                ...
                                <asp:Button ID="btnExportURD2" runat="server" Text="<%$ Resources:Resource, btnExportExcel %>" CssClass="btn Back" UseSubmitBehavior="true" OnClick="btnExportURD2_Click" Width="100px"/>
                            </td>
                        </tr>
                    </table>
                    <asp:GridView ID="gvURD2" runat="server" CssClass="table table-bordered table-condensed Grid" AllowPaging="true" PageSize="30" OnPageIndexChanging="gvURD2_PageIndexChanging">
                        <AlternatingRowStyle BackColor="#ffffff" />
                        <FooterStyle ForeColor="White" />
                        <HeaderStyle Font-Bold="True" ForeColor="White" HorizontalAlign="Left" />
                        <PagerStyle Font-Bold="True" ForeColor="White" HorizontalAlign="Center" />
