...
{
    public partial class WarrantyClaimDebitNoteCreate : BasePage
    {
        public override SubModule SubModuleName { get { return SubModule.ViewService_WarrantyClaimDebitNoteCreate; } }
        ...
        void fillWarrantyInvoice()
        {
            ...
            {
                new FileLogger().LogMessage("WarrantyClaimDebitNoteCreate", "fillWarrantyInvoice", e1);
                throw e1;
            }
        }
        ...
        protected void btnCreateDebitNote_Click(object sender, EventArgs e)
        {
            ...
            PDMS_Customer Supplier = new BDMS_Customer().GetCustomerAE(DateTime.Now);
            PDMS_Customer Buyer = new BDMS_Customer().getDealerAddressFromSAP(lblDealerCode.Text);
