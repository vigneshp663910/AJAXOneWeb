...
{
    public partial class ICTicketStatusReport : BasePage
    {
        public override SubModule SubModuleName { get { return SubModule.ViewService_ICTicketStatusReport; } }
        ...
        void fillICTicket()
        {
            try
            {
                ...
                SOIs = new BDMS_ICTicket().GetICTicketStatusReport(DealerID, txtCustomerCode.Text.Trim(), txtICTicketNumber.Text.Trim(), ICTicketDateF, ICTicketDateT, StatusID, txtMachineSerialNumber.Text.Trim());
            ...
            {
                new FileLogger().LogMessage("ICTicketStatusReport", "fillICTicket", e1);
                throw e1;
            }
        }
        ...
        protected void btnExportExcel_Click(object sender, EventArgs e)
        {
            ...
            dt.Columns.Add("NoClaim");
            dt.Columns.Add("NoClaimReason");
            dt.Columns.Add("Day Left For Claim Creation");
            ...
            dt.Columns.Add("Days Since Claim Creation");
            ...
            foreach (PDMS_ICTicket IC in ICTicket)
            {
                dt.Rows.Add(
                    ...
                    , IC.NoClaim
                    , IC.NoClaimReason
                    , IC.DayLeftForClaimCreation
                    , IC.Invoice == null ? "" : IC.Invoice.InvoiceNumber
                    , IC.Invoice == null ? "" : IC.Invoice.InvoiceDate.ToShortDateString()
                    , IC.Claim.InvoiceNumber
                    , IC.Claim.InvoiceDate == null ? "" : ((DateTime)IC.Claim.InvoiceDate).ToShortDateString()
                    , IC.Claim.ClaimStatus
                    , IC.Claim.DaysSinceClaimCreation
