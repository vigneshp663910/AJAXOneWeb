    ...
    public partial class MTTR_New : BasePage
    {
        ...
        void fillMTTR()
        {
            try
            {
                ...
                PApiResult Result = new BDMS_MTTR().GetMTTR(DealerID, txtCustomerCode.Text.Trim(), txtICTicketNumber.Text.Trim(), txtICLoginDateFrom.Text.Trim(), txtICLoginDateTo.Text.Trim(), StatusID, Division, "0", PageIndex, gvICTickets.PageSize);
        ...
        protected void btnExportExcel_Click(object sender, EventArgs e)
        {
            ...
            //   List<PDMS_MTTR_New> MttrsWithText
            PApiResult Result = new BDMS_MTTR().GetMTTR(DealerID, txtCustomerCode.Text.Trim(), txtICTicketNumber.Text.Trim(), txtICLoginDateFrom.Text.Trim(), txtICLoginDateTo.Text.Trim(), StatusID, Division, ddlExportExcelType.SelectedValue, PageIndex, gvICTickets.PageSize);
        ...
        //    List<PDMS_ServiceNote> BreakdownAll = new BDMS_Service().GetServiceNoteForMTTR(DealerID, txtCustomerCode.Text.Trim(), txtICTicketNumber.Text.Trim(), ICTicketDateF, ICTicketDateT, StatusID, PSession.User.UserID);
        //    List<Technician> TechniciansALL = fillTechnicianForMTTR();
        //    // int Index = 0;
        //    // int Rowcount = 5000;
        //    //  int CRowcount = Rowcount;
        //    //   while (Rowcount == CRowcount)
        //    //   {
        //    //     Index = Index + 1;
        //    PApiResult Result = new BDMS_MTTR().GetMTTR(DealerID, txtCustomerCode.Text.Trim(), txtICTicketNumber.Text.Trim(), txtICLoginDateFrom.Text.Trim(), txtICLoginDateTo.Text.Trim(), StatusID, Division, null, null);
        ...
        //        List<PDMS_ServiceNote> Breakdown = BreakdownAll.Where(s => s.ICTicketID == M.ICTicketID).ToList();
        //        //List<Technician> Technicians = fillTechnician(M.ICTicketID);
        //        List<Technician> Technicians = TechniciansALL.Where(s => s.ICTicketID == M.ICTicketID).ToList();
        ...
        //    List<PDMS_ServiceNote> BreakdownAll = new BDMS_Service().GetServiceNoteForMTTR(Convert.ToDateTime(txtICLoginDateFrom.Text.Trim()), Convert.ToDateTime(txtICLoginDateTo.Text.Trim()));
        ...
        List<Technician> fillTechnicianForMTTR()
        {
            int? DealerID = ddlDealerCode.SelectedValue == "0" ? (int?)null : Convert.ToInt32(ddlDealerCode.SelectedValue);
            int? StatusID = ddlStatus.SelectedValue == "0" ? (int?)null : Convert.ToInt32(ddlStatus.SelectedValue);
            string Division = "";
            ...
            List<Technician> tech = new List<Technician>();
            List<PDMS_ServiceTechnician> Technicians = new BDMS_Service().GetTechniciansForMTTR(DealerID, txtCustomerCode.Text.Trim(), txtICTicketNumber.Text.Trim(), ICTicketDateF, ICTicketDateT, StatusID, PSession.User.UserID);
            foreach (PDMS_ServiceTechnician t in Technicians)
            {
