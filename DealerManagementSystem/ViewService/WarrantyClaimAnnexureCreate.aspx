...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container">
        ...
        <div class="col2">
            ...
            <asp:Label ID="lblMessage" runat="server" Text="" CssClass="label" Width="100%" Font-Bold="false" Font-Size="20px" />

            <table id="txnHistory1:panelGridid" style="height: 100%; width: 100%">
                <tr>
                    <td>
                        <div class="boxHead">
                            <div class="logheading">Filter :Create Annexure </div>
                            ...
                            <div class="rf-p " id="txnHistory:inputFiltersPanel">
                                <div class="rf-p-b " id="txnHistory:inputFiltersPanel_body">
                                    ...
                                    <table class="labeltxt">
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="Label2" runat="server" CssClass="label" Text="Approved Month"></asp:Label></td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="Label4" runat="server" CssClass="label" Text="Delivery Challan" Visible="false"></asp:Label></td>
                                            <td>
                                                <asp:TextBox ID="txtDeliveryChallan" runat="server" CssClass="input" Visible="false" />
                    ...
                    <td>
                        <span id="txnHistory1:refreshDataGroup">
                            ...
                            <div style="padding: 3px; padding-bottom: 21px;">
                                ...
                                <asp:Button ID="btnExportExcel" runat="server" Text="<%$ Resources:Resource, btnExportExcel %>" CssClass="InputButtonRight" UseSubmitBehavior="true" OnClick="btnExportExcel_Click" BackColor="#1deaff" />
                            ...
                            <div style="background-color: white">
                                <asp:GridView ID="gvICTickets" runat="server" AutoGenerateColumns="false" Width="100%" DataKeyNames="InvoiceNumber" CssClass="TableGrid"
