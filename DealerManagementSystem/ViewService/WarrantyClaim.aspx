...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table id="txnHistory1:panelGridid" style="height: 100%; width: 100%">
        <tr>
            <td>
                <div class="boxHead">
                    <div class="logheading">Filter : Warranty Claim Raised</div>
                ...
                <asp:Panel ID="Panel2" runat="server">
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-12">
                                <asp:Label ID="Label4" runat="server" Text="IC Login Date To"></asp:Label>
                            ...
                            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-12">
                                <asp:Label ID="Label8" runat="server" Text="TSIR Number :"></asp:Label>
                                <asp:TextBox ID="txtTSIRNumber" runat="server"></asp:TextBox>
                            </div>
                            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-12">
                                <asp:Label ID="Label2" runat="server" Text="Claim Status"></asp:Label>
                                <asp:DropDownList ID="ddlStatus" runat="server" CssClass="TextBox" />
                            </div>
                            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-12">
                                <asp:Label ID="Label10" runat="server" Text="Final Approved Date From :"></asp:Label>
                                <asp:TextBox ID="txtApprovedDateF" runat="server" AutoComplete="Off"></asp:TextBox>
                            ...
                            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-12">
                                <asp:Label ID="Label11" runat="server" Text=" Final Approved Date To"></asp:Label>
                                <asp:TextBox ID="txtApprovedDateT" runat="server" AutoComplete="Off"></asp:TextBox>
                             ...
                             <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-12"  style="display:none">
                                <asp:Label ID="Label13" runat="server" Text="Customer Code"></asp:Label>
                                <asp:TextBox ID="txtCustomerCode" runat="server"></asp:TextBox>
                            </div>
                             <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-12"  style="display:none">
                                <asp:Label ID="Label14" runat="server" Text="MC Serial No"></asp:Label>
                            ...
                            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-12" style="display:none">
                                ...
                                <asp:DropDownList ID="ddlReoprt" runat="server">
                                    <asp:ListItem Value="0">By Claim</asp:ListItem>
                                    <asp:ListItem Value="1">By ICTicket</asp:ListItem>
                                </asp:DropDownList>
                            </div>
                            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-12">
                                <asp:Label ID="Label12" runat="server" Text="Is Above 50K"></asp:Label>
                                <asp:CheckBox ID="cbIsAbove50K" runat="server" />
                            </div>
                ...
                <td>
                    <span id="txnHistory1:refreshDataGroup">
                        ...
                        <div style="background-color: white">
                            ...
                            <asp:GridView ID="gvClaimByTicket" runat="server" AutoGenerateColumns="false" Width="100%" DataKeyNames="ICTicketID" OnRowDataBound="gvClaimByTicket_RowDataBound" CssClass="TableGrid" AllowPaging="true" PageSize="20" OnPageIndexChanging="gvICTickets_PageIndexChanging">
                                <Columns>
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                                    ...
                                                    <div id="ICTicketID-<%# Eval("ICTicketID") %>" style="display: inline; position: relative;">
                                                        <asp:GridView ID="gvICTicketItems" runat="server" AutoGenerateColumns="false" CssClass="TableGrid" Width="100%" AllowPaging="true" PageSize="20" OnPageIndexChanging="gvICTickets_PageIndexChanging">
                                                            <Columns>
                                                                ...
                                                                <%--   <asp:TemplateField HeaderText="Invoice Number New">
                                                                        <ItemStyle VerticalAlign="Middle" HorizontalAlign="Center" />
                                                                        <ItemTemplate>
                                                                             <asp:Label ID="lblInvoiceNumberNew" Text='<%# DataBinder.Eval(Container.DataItem, "InvoiceNumberNew")%>' runat="server"></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>--%>
