...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="col-md-12">
        <div class="col-md-12">
            <fieldset class="fieldset-border">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-2 col-sm-12">
                        <label class="modal-label">Pro Invoice Number</label>
                        <asp:TextBox ID="txtInvoiceNumber" runat="server" CssClass="form-control" BorderColor="Silver"></asp:TextBox>
                    </div>
                    <div class="col-md-2 col-sm-12">
                        <label class="modal-label">Pro Invoice Date From </label>
                    ...
                    <div class="col-md-2 col-sm-12">
                        <label class="modal-label">Pro Invoice Date To</label>
        ...
        <div class="col-md-12 Report">
            <fieldset class="fieldset-border">
                <legend style="background: none; color: #007bff; font-size: 17px;">Proforma Invoice</legend>
                <div class="col-md-12 Report">
                    <div class="boxHead">
