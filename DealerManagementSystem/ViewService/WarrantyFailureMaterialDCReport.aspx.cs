...
{
    public partial class WarrantyFailureMaterialDCReport : BasePage
    {
        public override SubModule SubModuleName { get { return SubModule.ViewService_WarrantyFailureMaterialDCReport; } }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Page.ClientScript.RegisterStartupScript(this.GetType(), "Script1", "<script type='text/javascript'>SetScreenTitle('Service » Failed Material » Warranty DC Report');</script>");
        ...
        public PAttachedFile DeliveryChellanPrint(long DeliveryChallanID)
        {
            try
            {
                ...
                PDMS_Customer DealerAD = new BDMS_Customer().getDealerAddressFromSAP(FM.Dealer.DealerCode);
