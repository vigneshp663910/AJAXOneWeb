            ...
            <fieldset class="fieldset-border">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-2 col-sm-12">
                        ...
                        <asp:TextBox ID="txtICServiceTicket" runat="server" CssClass="form-control"></asp:TextBox>
                    </div>
                    <div class="col-md-2 col-sm-12">
                    ...
                    <div class="col-md-2 col-sm-12">
                        ...
                        <asp:TextBox ID="txtTSIRNumber" runat="server" CssClass="form-control"></asp:TextBox>
                    </div>
                    <div class="col-md-2 col-sm-12">
                    ...
                    <div class="col-md-8 text-left">
                        ...
                        <asp:Button ID="btnExportExcel" runat="server" Text="<%$ Resources:Resource, btnExportExcel %>" CssClass="btn Search" UseSubmitBehavior="true" OnClick="btnExportExcel_Click" Visible="false" />
                        <asp:Button ID="Button1" runat="server" Text="Export Excel for SAP" CssClass="btn Search" UseSubmitBehavior="true" OnClick="btnExportExcelForSAP_Click" Width="150px" />
                ...
                <div class="col-md-12 Report">
                    <fieldset class="fieldset-border">
                        ...
                        <asp:GridView ID="gvICTickets" runat="server" AutoGenerateColumns="false" Width="100%" DataKeyNames="WarrantyInvoiceHeaderID"
                            OnRowDataBound="gvICTickets_RowDataBound" CssClass="table table-bordered table-condensed Grid" AllowPaging="true" PageSize="10" OnPageIndexChanging="gvICTickets_PageIndexChanging">
                            <Columns>
                                <asp:TemplateField>
                                    <ItemTemplate>
            ...
            <fieldset class="fieldset-border">
                ...
                <div class="col-md-12">
                    <div class="col-md-2 col-sm-12">
                        ...
                        <asp:DropDownList ID="ddlDCTemplate" runat="server" CssClass="form-control" OnSelectedIndexChanged="ddlDCTemplate_SelectedIndexChanged" AutoPostBack="true" />
                    </div>
                    <div class="col-md-2 col-sm-12">
                        <asp:Label ID="lblTemplateName" runat="server" CssClass="modal-label" Text="Draft Remarks"></asp:Label> 
                        <asp:TextBox ID="txtTemplateName" runat="server" CssClass="form-control"></asp:TextBox>
                    </div>
                    <div class="col-md-8 text-left">
                        <label class="modal-label">-</label>
                        <asp:Button ID="btnCreateTemplate" runat="server" Text="Create" CssClass="btn Search" UseSubmitBehavior="true" OnClick="btnCreateTemplate_Click" />
                    </div>
                </div>
            </fieldset>
        </div>
