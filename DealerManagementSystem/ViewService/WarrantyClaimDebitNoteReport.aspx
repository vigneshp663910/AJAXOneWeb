<%@ Page Title="" Language="C#" MasterPageFile="~/Dealer.Master" AutoEventWireup="true" CodeBehind="WarrantyClaimDebitNoteReport.aspx.cs" Inherits="DealerManagementSystem.ViewService.WarrantyClaimDebitNoteReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="col-md-12">
            ...
            <fieldset class="fieldset-border">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-12 text-center">
                        ...
                        <asp:Button ID="Button1" runat="server" Text="Export Excel for SAP" CssClass="btn Back" UseSubmitBehavior="true" OnClick="btnExportExcelForSAP_Click" Width="160px"/>
                    </div>
                </div>
            </fieldset>
        </div>
        <div class="col-md-12 Report">
            <fieldset class="fieldset-border">
                <legend style="background: none; color: #007bff; font-size: 17px;">Debit Note Report</legend>
                <div class="col-md-12 Report">
                    <div class="boxHead">
                    ...
                    <asp:GridView ID="gvClaimInvoice" runat="server" AutoGenerateColumns="false" Width="100%" DataKeyNames="WarrantyClaimDebitNoteID" OnRowDataBound="gvICTickets_RowDataBound" CssClass="table table-bordered table-condensed Grid" AllowPaging="true" PageSize="20" OnPageIndexChanging="gvICTickets_PageIndexChanging">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Debit Number">
                            ...
                            <asp:TemplateField HeaderText="Acknowledged">
                                <ItemStyle VerticalAlign="Middle" HorizontalAlign="Left" />
                                <ItemTemplate>
                                    <asp:Label ID="lblIsAcknowledged" Text='<%# DataBinder.Eval(Container.DataItem, "IsAcknowledged")%>' runat="server"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="TDS Value">
                                <ItemStyle VerticalAlign="Middle" HorizontalAlign="Left" />
                                <ItemTemplate>
