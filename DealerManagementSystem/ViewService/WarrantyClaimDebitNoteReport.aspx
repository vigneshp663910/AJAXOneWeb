<%@ Page Title="" Language="C#" MasterPageFile="~/Dealer.Master" AutoEventWireup="true" CodeBehind="WarrantyClaimDebitNoteReport.aspx.cs" Inherits="DealerManagementSystem.ServiceView.WarrantyClaimDebitNoteReport" %>
        ...
        <div class="col2">
            ...
            <table id="txnHistory1:panelGridid" style="height: 100%; width: 100%">
                <tr>
                    <td>
                        <div class="boxHead">
                            <div class="logheading">Filter : Debit Note Report</div>
