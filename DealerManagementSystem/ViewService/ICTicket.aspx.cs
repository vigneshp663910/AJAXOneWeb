    ...
    public partial class ICTicket : BasePage
    {
        ...
        PApiResult GetICTicket(int Excel)
        {
            try
            {
               ...
               return new BDMS_ICTicket().GetICTicketManage(DealerID, txtCustomerCode.Text.Trim(), txtICTicketNumber.Text.Trim(), ICTicketDateF, ICTicketDateT, StatusID, TechnicianID, ServiceTypeID, Division, Excel, PageIndex, gvICTickets.PageSize);
