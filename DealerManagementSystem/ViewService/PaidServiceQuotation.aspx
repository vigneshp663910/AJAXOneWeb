        ...
        <div class="col2">
            ...
            <table id="txnHistory1:panelGridid" style="height: 100%; width: 100%">
                <tr>
                    <td>
                        <div class="boxHead">
                            <div class="logheading">Quotation</div>
                                       ...
                                       <tr>
                                        ...
                                        <tr>
                                            <td>
                                                <div>
                                                    <div class="tbl-col-left">
                                                        <asp:Label ID="lblPlant" runat="server" CssClass="label" Text="Quotation Number"></asp:Label>
                                                    </div>
                                                    <div class="tbl-col-right">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="tbl-row-left">
                                                    <div class="tbl-col-left">
                                                        <asp:Label ID="Label3" runat="server" CssClass="label" Text="Quotation Date From "></asp:Label>
                                                    </div>
                                                    <div class="tbl-col-right">
                                                ...
                                                <div class="tbl-row-right">
                                                    <div class="tbl-col-left">
                                                        <asp:Label ID="Label4" runat="server" CssClass="label" Text="Quotation Date To"></asp:Label>
                                                    </div>
                                                    <div class="tbl-col-right">
