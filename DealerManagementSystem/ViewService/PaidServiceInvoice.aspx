<%@ Page Title="" Language="C#" MasterPageFile="~/Dealer.Master" AutoEventWireup="true" CodeBehind="PaidServiceInvoice.aspx.cs" Inherits="DealerManagementSystem.ViewService.PaidServiceInvoice" %>
                    ...
                    <asp:GridView ID="gvClaimInvoice" runat="server" AutoGenerateColumns="false" Width="100%" DataKeyNames="PaidServiceInvoiceID" OnRowDataBound="gvICTickets_RowDataBound" CssClass="table table-bordered table-condensed Grid" AllowPaging="true" PageSize="20" OnPageIndexChanging="gvICTickets_PageIndexChanging">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Customer GST No">
                                <ItemStyle VerticalAlign="Middle" HorizontalAlign="Left" />
                                <ItemTemplate>
                                    <asp:Label ID="lblGSTIN" Text='<%# DataBinder.Eval(Container.DataItem, "ICTicket.Customer.GSTIN")%>' runat="server"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="IC Ticket Number">
                                <ItemStyle VerticalAlign="Middle" HorizontalAlign="Center" />
                                <ItemTemplate>
                                    <asp:Label ID="lblICTicketNumber" Text='<%# DataBinder.Eval(Container.DataItem, "ICTicket.ICTicketNumber")%>' runat="server"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Cancel">
                                <ItemStyle VerticalAlign="Middle" HorizontalAlign="Center" />
                                <ItemTemplate>
                                    <asp:CheckBox ID="cbIsActiveInvoice" runat="server" Checked='<%# DataBinder.Eval(Container.DataItem, "IsActiveInvoice")%>' Visible="false" />
                                    <asp:LinkButton ID="lbQuotationCancel" runat="server" OnClick="lbQuotationCancel_Click" Visible="false">Cancel</asp:LinkButton>
                                    <asp:Label ID="lblCancel" runat="server" Text="Canceled" Visible="false"> </asp:Label>
                                    <tr>
