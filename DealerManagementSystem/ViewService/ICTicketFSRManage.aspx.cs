...
namespace DealerManagementSystem.ViewService
{
    public partial class ICTicketFSRManage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Page.ClientScript.RegisterStartupScript(this.GetType(), "Script1", "<script type='text/javascript'>SetScreenTitle('Service » IC Ticket FSR Manage');</script>");
        ...
        //             if ((FileNameID == (short)FSRAttachedFileName.BeforeMachineRestore) || (FileNameID == (short)FSRAttachedFileName.AfterMachineRestore)
        //                 || (FileNameID == (short)FSRAttachedFileName.Technician) || (FileNameID == (short)FSRAttachedFileName.Customer)
        //                  || (FileNameID == (short)FSRAttachedFileName.TechnicianSignature) || (FileNameID == (short)FSRAttachedFileName.CustomerSignature)
        //                 )
        //             {
        //                 PDMS_FSRAttachedFile F1 = new BDMS_ICTicketFSR().GetICTicketFSRAttachedFileByID(FSRFileAll[i].AttachedFileID);
        ...
        //                 AfterMachineRestoreFilePath = new Uri(Server.MapPath("~/" + Path)).AbsoluteUri;
        //             }
        //             else if (FileNameID == (short)FSRAttachedFileName.Technician)
        //             {
        //                 TechnicianFilePath = new Uri(Server.MapPath("~/" + Path)).AbsoluteUri;
        //             }
        //             else if (FileNameID == (short)FSRAttachedFileName.Customer)
        ...
        //        ReportParameter[] P = new ReportParameter[59];
