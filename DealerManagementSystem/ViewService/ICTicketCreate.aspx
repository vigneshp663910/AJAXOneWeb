    ...
    <div class="col-md-12">
                ...
                <fieldset class="fieldset-border" id="Fieldset1" runat="server">
                    <div class="col-md-12"> 
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <asp:TextBox ID="txtEquipment" runat="server" CssClass="form-control" BorderColor="Silver" TextMode="Date" WatermarkCssClass="WatermarkCssClass"></asp:TextBox>
                        </div>
        ...
        <fieldset class="fieldset-border" id="Fieldset2" runat="server">
            <div class="col-md-12"> 
                ...
                <div class="col-md-6 col-sm-12">
                    <label class="modal-label">Country
