<%@ Page Title="" Language="C#" MasterPageFile="~/Dealer.Master" AutoEventWireup="true" CodeBehind="ICTicketTSIRApprove.aspx.cs" Inherits="DealerManagementSystem.ServiceView.ICTicketTSIRApprove" %>
    ...
    <asp:Panel ID="pnlTSIRManage" runat="server">
        <table id="txnHistory1:panelGridid" style="height: 100%; width: 100%">
            <tr>
                <td>
                    <div class="boxHead">
                        <div class="logheading">Filter : TSIR Approve</div>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-12">
                                ...
                                <asp:TextBox ID="txtNatureOfFailures" runat="server" TextMode="MultiLine" Height="100px" Enabled="false"></asp:TextBox>
                            </div>

                            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-12">
                                <asp:Label ID="Label15" runat="server" CssClass="label" Text="How Was Problem Noticed / Who  / When"></asp:Label>
                                <asp:TextBox ID="txtProblemNoticedBy" runat="server" TextMode="MultiLine" Height="100px" Enabled="false"></asp:TextBox>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-12">
                                <asp:Label ID="Label28" runat="server" CssClass="label" Text="Under What Condition Did The Failure Taken Place"></asp:Label>
                                <asp:TextBox ID="txtUnderWhatConditionFailureTaken" runat="server" TextMode="MultiLine" Height="100px" Enabled="false"></asp:TextBox>
                            </div>

                            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-12">
                                <asp:Label ID="Label16" runat="server" CssClass="label" Text="Failure Details"></asp:Label>
                                <asp:TextBox ID="txtFailureDetails" runat="server" TextMode="MultiLine" Height="100px" Enabled="false"></asp:TextBox>
                            </div>
                            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-12">
                                <asp:Label ID="Label22" runat="server" CssClass="label" Text="Points Checked"></asp:Label>
                                <asp:TextBox ID="txtPointsChecked" runat="server" TextMode="MultiLine" Height="100px" Enabled="false"></asp:TextBox>
                            </div>

                            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-12">
                                <asp:Label ID="lblHMRValue" runat="server" CssClass="label" Text="Possible Root Causes"></asp:Label>
                                <asp:TextBox ID="txtPossibleRootCauses" runat="server" TextMode="MultiLine" Height="100px" Enabled="false"></asp:TextBox>
                            </div>
                            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-12">
                                <asp:Label ID="Label23" runat="server" CssClass="label" Text="Specific Points Noticed"></asp:Label>
                                <asp:TextBox ID="txtSpecificPointsNoticed" runat="server" TextMode="MultiLine" Enabled="false"></asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-12">
                                <asp:Label ID="lblSales1ApproveAmount" runat="server" CssClass="label" Text="Sales 1 Approve Amount"></asp:Label>
                                <asp:TextBox ID="txtSales1ApproveAmount" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-12">
                                <asp:Label ID="lblSales2ApproveAmount" runat="server" CssClass="label" Text="Sales 2 Approve Amount"></asp:Label>
                                <asp:TextBox ID="txtSales2ApproveAmount" runat="server"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                </td>
                ...
                <td>
                    ...
                    <asp:Panel ID="Panel1" runat="server">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-12" style="text-align: right; vertical-align: bottom; padding-top: 10px;">
                                    <asp:Button ID="btnSalesApprove1" runat="server" Text="Approve" CssClass="InputButton" UseSubmitBehavior="true" OnClick="btnSalesApprove1_Click" Visible="false" />
                                    <asp:Button ID="btnSalesApprove2" runat="server" Text="Approve" CssClass="InputButton" UseSubmitBehavior="true" OnClick="btnSalesApprove2_Click" Visible="false" />
                                    &nbsp; &nbsp;                                    
                                </div>
                                <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-12" style="text-align: right; vertical-align: bottom; padding-top: 10px;">
                                ...
                                <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-12" style="text-align: right; vertical-align: bottom; padding-top: 10px;">
                                    <asp:Button ID="btnSalesReject" runat="server" Text="Reject" CssClass="InputButton" UseSubmitBehavior="true" OnClick="btnSalesReject_Click" Visible="false" />
                                </div>
                            </div>
                        </div>
                    </asp:Panel>
