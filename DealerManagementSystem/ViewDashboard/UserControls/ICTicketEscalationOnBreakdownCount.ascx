...
<div class="tile-size-one grid-item">
    <div class="content">
       <div class="details">
            ...
            <asp:Label ID="lblBreakDown8" runat="server" />
        </asp:HyperLink>
            <div class="desc">
...
<div class="tile-size-two grid-item">
    ...
    <%--<div class="dashboard-stat dashboard-stat-v2 purple-intense" href="javascript:void(0);" onclick="VisitMyEnquiries('');">--%>
        <div class="details">
            ...
            <asp:Label ID="lblBreakDown24" runat="server" />
        </asp:HyperLink>
            <div class="desc">
...
<div class="tile-size-three grid-item">
    <div class="content">
        ...
        <asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl="~/DMS_ICTicketEscalationOnBreakdown.aspx">
            <asp:Label ID="lblBreakDown48" runat="server" />
        </asp:HyperLink>
            <div class="desc">
    ...
    <div class="content">
        <div class="details">
            <asp:HyperLink ID="HyperLink4" runat="server" NavigateUrl="~/DMS_ICTicketEscalationOnBreakdown.aspx">
                <asp:Label ID="lblBreakDown72" runat="server" />
            </asp:HyperLink>
                <div class="desc">
