<%@ Page Title="" Language="C#" MasterPageFile="~/Dealer.Master" AutoEventWireup="true" CodeBehind="BankDepositClearingEditAndConfirm.aspx.cs" Inherits="DealerManagementSystem.ViewFinance.BankDepositClearingEditAndConfirm" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <%-- <table id="txnHistory4:panelGridid" style="height: 100%; width: 100%">
        <tr>
            <td>
                <div class="boxHead" style="height: 2px; background-color: #fbfbfb;"></div>
            </td>
        </tr>
    </table>--%>
                                    ...
                                    <table class="labeltxt fullWidth">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="tbl-row-left">
                                                    <div class="tbl-col-left">
                                                        <asp:Label ID="Label3" runat="server" Text="CreatedBy" CssClass="label"></asp:Label>
                                                    </div>
                                                    <div class="tbl-col-right">
                                ...
                                <div style="background-color: white" class="tablefixedWidth" id="tablefixedWidthID">
                                    <asp:GridView ID="gvSo" runat="server" AutoGenerateColumns="false" CssClass="TableGrid" AllowPaging="true" DataKeyNames="BankDepositClearingID" PageSize="20">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Deposit For">
                                                <ItemStyle VerticalAlign="Middle" HorizontalAlign="Center" />
                                                <ItemTemplate>
...
<%--                                            <asp:TemplateField HeaderText="Reference No">
                                            ...
                                            <asp:TemplateField HeaderText="">
                                                <ItemStyle VerticalAlign="Middle" HorizontalAlign="Center" />
                                                <ItemTemplate>
                                                    <asp:Button ID="btnEdit" runat="server" Text="Edit" CssClass="InputButton" UseSubmitBehavior="true" OnClick="btnEdit_Click" />
                                                    <asp:Button ID="btnDelete" runat="server" Text="Delete" CssClass="InputButton" UseSubmitBehavior="true" OnClick="btnDelete_Click" />
                                                   <asp:Button ID="btnConfirm" runat="server" Text="Confirm" CssClass="InputButton" UseSubmitBehavior="true" OnClick="btnConfirm_Click" />
                                                </ItemTemplate>
                                            </asp:TemplateField>                                           
                                        </Columns>
                                    </asp:GridView>
