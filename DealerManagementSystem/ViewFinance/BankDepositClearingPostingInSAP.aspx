<%@ Page Title="" Language="C#" MasterPageFile="~/Dealer.Master" AutoEventWireup="true" CodeBehind="BankDepositClearingPostingInSAP.aspx.cs" Inherits="DealerManagementSystem.ViewFinance.BankDepositClearingPostingInSAP" %>
                                            ...
                                            <td>
                                                <div class="tbl-col">
                                                    <div class="tbl-col-left">
                                                        <asp:Label ID="Label13" runat="server" Text="Dealer" CssClass="label"></asp:Label>
                                                    </div>
                                         ...
                                         <%--   <asp:TemplateField HeaderText="Reference No">
                                            ...
                                            <asp:TemplateField HeaderText="">
                                                ...
                                                <ItemTemplate>
                                                  ...
                                                  <asp:Button ID="btnPostInSAP" runat="server" Text="Post In SAP" CssClass="InputButton" UseSubmitBehavior="true" OnClick="btnPostInSAP_Click" />
                                                </ItemTemplate>
                                            </asp:TemplateField>                                           
                                        </Columns>
                                    </asp:GridView> 
