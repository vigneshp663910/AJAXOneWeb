<%@ Page Title="" Language="C#" MasterPageFile="~/Dealer.Master" AutoEventWireup="true" CodeBehind="VoiceText.aspx.cs" Inherits="DealerManagementSystem.VoiceText" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>My Chat application</title>
     <script src="Scripts/Voice/jquery-3.3.1.js" ></script>
    <script src="Scripts/Voice/jquery-3.3.1.min.js" ></script>
    <script src="Scripts/Voice/jquery.signalR-2.2.2.min.js"></script>
