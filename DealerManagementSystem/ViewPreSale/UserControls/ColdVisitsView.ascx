        ...
        <div class="col-md-12 View">
            <div class="col-md-4">
                ...
                <div class="col-md-12">
                    ...
                    <asp:Label ID="lblPersonMet" runat="server" CssClass="LabelValue"></asp:Label>
                </div>
            </div>
            <div class="col-md-4">
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                 ...
                 <div class="col-md-12">
                    ...
                    <asp:Label ID="lblPersonDesignation" runat="server" CssClass="LabelValue"></asp:Label>
                </div>
            </div>
            <div class="col-md-4">
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                    ...
                    <asp:Label ID="lblImportance" runat="server" CssClass="LabelValue"></asp:Label>
                </div>
                <div class="col-md-12">
                    <label>Status : </label>
