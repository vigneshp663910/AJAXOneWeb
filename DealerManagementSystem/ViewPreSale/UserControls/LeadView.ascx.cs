...
namespace DealerManagementSystem.ViewPreSale.UserControls
{
    ...
    { 
        ...
        void fillVisit()
        {
            List<PColdVisit> Visit = new BColdVisit().GetColdVisit(null, null, null, null, null, null, null, null, null, null, 1, Lead.LeadID, null, null, null);
        ...
        void ActionControlMange()
        {
           ...
           // lbtnAddQuotation.Visible = true;
            ...
            if ((Lead.Status.StatusID == (short)LeadStatus.Dropped) 
                || (Lead.Status.StatusID == (short)LeadStatus.SalesLost)
                || (Lead.Status.StatusID == (short)LeadStatus.Won)
                )
            {
                lbtnEditLead.Visible = false;
