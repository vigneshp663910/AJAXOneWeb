<%@ Page Title="" Language="C#" MasterPageFile="~/Dealer.Master" AutoEventWireup="true" CodeBehind="BudgetPlanningYear.aspx.cs" Inherits="DealerManagementSystem.ViewPreSale.Planning.BudgetPlanningYear" %>
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="RId" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="35px">
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="lblModelID" Text='<%# DataBinder.Eval(Container.DataItem, "Model.ModelID")%>' runat="server" Visible="false" />
                                            <itemstyle width="25px" horizontalalign="Right"></itemstyle>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Dealer">
                                        <ItemTemplate>
                                            <asp:Label ID="lblDepartment" Text='<%# DataBinder.Eval(Container.DataItem, "Dealer.DealerCode")%>' runat="server" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Model">
                                        <ItemTemplate>
                                            <asp:Label ID="lblModel" Text='<%# DataBinder.Eval(Container.DataItem, "Model.Model")%>' runat="server" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Budget"  ItemStyle-HorizontalAlign="right">
                                        <ItemTemplate>
                                            ...
                                            <asp:TextBox ID="txtBudget" Text='<%# DataBinder.Eval(Container.DataItem, "Budget")%>' runat="server" CssClass="form-control" TextMode="Number" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
