                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Dealer Code" ItemStyle-Width="30px">
                         ...
                         <asp:TemplateField HeaderText="Dealer Name" ItemStyle-Width="30px">
                            <ItemStyle VerticalAlign="Middle" HorizontalAlign="Center" />
                            <ItemTemplate> 
                                <asp:Label ID="lblDealerCode" Text='<%# DataBinder.Eval(Container.DataItem, "DealerName")%>' runat="server" />
                            </ItemTemplate>
                        </asp:TemplateField> 
                        <asp:TemplateField HeaderText="Days 0 to 3" ItemStyle-Width="130px" ItemStyle-HorizontalAlign="right" FooterStyle-HorizontalAlign="Right">
                            <HeaderStyle BackColor="#ddebf7" />
                            <ItemTemplate>
                                <asp:Label ID="lblLeadGenerationPlan" Text='<%# DataBinder.Eval(Container.DataItem, "Days 0 to 3")%>' runat="server" />
                            </ItemTemplate>
                            <FooterTemplate>
                                <asp:Label ID="lblLeadGenerationPlanF" runat="server" ForeColor="Black" Font-Size="Large" />
                            </FooterTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Days 4 to 6" ItemStyle-Width="150px" ItemStyle-HorizontalAlign="right" FooterStyle-HorizontalAlign="Right">
                            <HeaderStyle BackColor="#c6e0b4" />
                            <ItemTemplate>
                                 <asp:LinkButton ID="lblLeadGenerationActual" Text='<%# DataBinder.Eval(Container.DataItem, "Days 3 To 6" )%>' runat="server" OnClick="lblLinkButton_Click" />
                        ...
                        <asp:TemplateField HeaderText="Days > 6" ItemStyle-Width="125px" ItemStyle-HorizontalAlign="right" FooterStyle-HorizontalAlign="Right">
                            <HeaderStyle BackColor="#a0e172" />
                            <ItemTemplate>
                                <asp:Label ID="lblLeadGenerationActualP" Text='<%# DataBinder.Eval(Container.DataItem, "Days > 6")%>' runat="server" />
                            </ItemTemplate>
                            <FooterTemplate>
