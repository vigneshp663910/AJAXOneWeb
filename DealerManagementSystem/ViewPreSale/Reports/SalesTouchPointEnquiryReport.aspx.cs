...
{
    public partial class SalesTouchPointEnquiryReport : BasePage
    {
        ...
        public override SubModule SubModuleName { get { return SubModule.ViewPreSale_SalesTouchPointEnquiryReport; } }
        ...
        {
            Search();
            PApiResult Result = new BSalesTouchPoint().GetSalesTouchPointEnquiryStatusReportPresale(SalesTouchPointEnquiryID, SalesTouchPointsEnquiryNumber, DateFrom, DateTo, CountryID, StateID, DistrictID, CustomerName, PageIndex, gvEnquiry.PageSize);
