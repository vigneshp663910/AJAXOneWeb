<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ICTicketCommonBasicInfo.ascx.cs" Inherits="DealerManagementSystem.UserControls.ICTicketCommonBasicInfo" %>
