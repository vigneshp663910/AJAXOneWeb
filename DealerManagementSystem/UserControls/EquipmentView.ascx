    ...
    <div class="col-md-12">
        <div class="col-md-12 Report">
            <fieldset class="fieldset-border">
                <legend style="background: none; color: #007bff; font-size: 17px;">Equipment Information</legend>
                <div class="col-md-12 Report">
                    <asp:GridView ID="gvEquipment" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered table-condensed Grid" Width="100%">
                        <Columns>
            ...
            <fieldset class="fieldset-border">
                <legend style="background: none; color: #007bff; font-size: 17px;">IC Ticket Information</legend>
                <div class="col-md-12 Report">
                                    ...
                                    <tr>
                                        <td colspan="100%" style="padding-left: 96px">
                                            <div id="ICTicketID-<%# Eval("ICTicketID") %>" style="display: inline; position: relative;">
                                                <asp:GridView ID="gvServiceCharges" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered table-condensed Grid" Width="100%" ShowFooter="true">
                                                    <Columns>
