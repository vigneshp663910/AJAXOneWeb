<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AvailabilityOfOtherMachine.ascx.cs" Inherits="DealerManagementSystem.UserControls.AvailabilityOfOtherMachine" %>
