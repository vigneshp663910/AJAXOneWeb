<%@ Page Title="" Language="C#" MasterPageFile="~/Dealer.Master" AutoEventWireup="true" CodeBehind="MachineOperatorApproval.aspx.cs" Inherits="DealerManagementSystem.ViewDealerEmployee.MachineOperatorApproval" %>
            ...
            <div class="col-md-12">
                <div class="col-md-12 Report">
                    <fieldset class="fieldset-border">
                        <legend style="background: none; color: #007bff; font-size: 17px;">Machine Operator Approve</legend>
                        <div class="col-md-12 Report">
                            <div class="boxHead">
                                <div class="logheading">
                                    <div style="float: left">
                                        <table>
                                            <tr>
                                                <td>Machine Operator Approve</td>
                                                <td>
                            ...
                            <asp:GridView ID="gvMOP" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-condensed Grid" AllowPaging="True"
                                DataKeyNames="MachineOperatorDetailsID" PageSize="20" OnPageIndexChanging="gvMOP_PageIndexChanging">
                                <Columns>
