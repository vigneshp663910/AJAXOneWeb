<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OnboardEmployeeRegistration.aspx.cs" MaintainScrollPositionOnPostback="false" Inherits="DealerManagementSystem.ViewDealerEmployee.OnboardEmployeeRegistration" %>
...
<body>
    <div class="jumbotron text-center">
        <h2>AjaxOne Employee ID Creation</h2>
    </div>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-12 text-center">
                                            ...
                                            <asp:Button ID="btnReset" runat="server" Text="Reset" CssClass="btn-success" UseSubmitBehavior="true" OnClick="btnReset_Click" />
                                        </div>
                                    </div>
                                    <br />
                                </div>
