<%@ Page Title="" Language="C#" MasterPageFile="~/Dealer.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="MachineOperatorManage.aspx.cs" Inherits="DealerManagementSystem.ViewDealerEmployee.MachineOperatorManage" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Src="~/ViewDealerEmployee/UserControls/MachineOperatorView.ascx" TagPrefix="UC" TagName="UC_MachineOperatorView" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="col-md-12" id="divMachineOperatorList" runat="server">
        <div class="col-md-12">
            <fieldset class="fieldset-border">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-2 col-sm-12">
                        <label class="modal-label">DL Number</label>
                        <asp:TextBox ID="txtDLNumber" runat="server" CssClass="form-control" BorderColor="Silver"></asp:TextBox>
                    </div>
                    <div class="col-md-2 col-sm-12">
            ...
            <div class="col-md-12 Report">
                <fieldset class="fieldset-border">
                    ...
                    <div class="col-md-12 Report">
                        ...
                        <asp:GridView ID="gvMachineOperator" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-condensed Grid" AllowPaging="True" DataKeyNames="MachineOperatorDetailsID" PageSize="20" OnPageIndexChanging="gvMachineOperator_PageIndexChanging">
                            <Columns>
    ...
    <div class="col-md-12" id="divMachineOperatorView" runat="server" visible="false">
        ...
        <UC:UC_MachineOperatorView ID="UC_MachineOperatorView" runat="server"></UC:UC_MachineOperatorView>
    </div>
</asp:Content>
