    ...
    <div class="action-btn">
        ...
        <div class="dropdown btnactions" id="customerAction">
            ...
            <div class="dropdown-content" style="font-size: small; margin-left: -105px">
                ...
                <asp:LinkButton ID="lbtnViewPDF" runat="server" OnClick="lbActions_Click">View PDF</asp:LinkButton>
                <asp:LinkButton ID="lbtnDownloadPDF" runat="server" OnClick="lbActions_Click">Download PDF</asp:LinkButton>
            </div>
        </div>
    </div>
</div>
