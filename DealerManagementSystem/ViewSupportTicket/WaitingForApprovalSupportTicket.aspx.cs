...
namespace DealerManagementSystem.ViewSupportTicket
{
    public partial class WaitingForApprovalSupportTicket : BasePage
    {
        ...
        {
            Page.ClientScript.RegisterStartupScript(this.GetType(), "Script1", "<script type='text/javascript'>SetScreenTitle('Task » Approve ');</script>");
        ...
        void FillTickets()
        {
            ...
            PApiResult Result = new BTickets().GetTicketsApprovaldetails(HeaderId, DealerId, txtRequestedDateFrom.Text.Trim(), txtRequestedDateTo.Text.Trim(), TicketCategoryID, TicketSubCategoryID, TicketSeverity, UserID, PageIndex, gvTickets.PageSize);
