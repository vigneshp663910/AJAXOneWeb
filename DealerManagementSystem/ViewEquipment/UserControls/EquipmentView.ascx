...
<asp1:TabContainer ID="tbpIbase" runat="server" ToolTip="IBase..." Font-Bold="True" Font-Size="Medium" ActiveTabIndex="1">
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-12 Report">
                    <div class="table-responsive">
                        <asp:GridView ID="gvICTicket" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered table-condensed Grid" DataKeyNames="ICTicketID" Width="100%" OnRowDataBound="gvICTicket_RowDataBound">
                            <Columns>
                                <asp:TemplateField>
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Warranty">
                                    <ItemStyle VerticalAlign="Middle" HorizontalAlign="Left" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblIsWarranty" Text='<%# DataBinder.Eval(Container.DataItem, "IsWarranty")%>' runat="server"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Reached Date">
                                    <ItemStyle VerticalAlign="Middle" HorizontalAlign="Left" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblReachedDate" Text='<%# DataBinder.Eval(Container.DataItem, "ReachedDate")%>' runat="server"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Restored Date">
                                    <ItemStyle VerticalAlign="Middle" HorizontalAlign="Left" />
                                    <ItemTemplate>
                                        ...
                                        <tr>
                                            <td colspan="100%" style="padding-left: 96px">
                                                <div id="ICTicketID-<%# Eval("ICTicketID") %>" style="display: inline; position: relative;">
                                                    <asp:GridView ID="gvServiceCharges" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered table-condensed Grid" Width="100%">
                                                        <Columns>
                ...
                <div class="table-responsive">
                    <asp:GridView ID="gvChgReqHst" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered table-condensed Grid" Width="100%" EmptyDataText="No Data Found"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Change Des">
                                <ItemStyle VerticalAlign="Middle" HorizontalAlign="Left" />
                                <ItemTemplate>
                                    <asp:Label ID="lblChangeDes" Text='<%# DataBinder.Eval(Container.DataItem, "ChangeDes")%>' runat="server"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
    ...
    <asp1:TabPanel ID="TabPanel1" runat="server" HeaderText="Online Ticket">
        <ContentTemplate>
            <div class="col-md-12">
                <div class="boxHead">
                    <div class="logheading">
                        <div style="float: left">
                            <asp:GridView ID="gvOnlineTickets" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered table-condensed Grid" AllowPaging="true" PageSize="20">
                                <Columns>
