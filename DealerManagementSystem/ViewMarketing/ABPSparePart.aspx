<%@ Page Title="" Language="C#" MasterPageFile="~/Dealer.Master" AutoEventWireup="true" CodeBehind="ABPSparePart.aspx.cs" Inherits="DealerManagementSystem.ViewMarketing.ABPSparePart" %>
    ...
    <asp:UpdatePanel ID="updPanel" runat="server">
        ...
        <ContentTemplate>
            <div class="row" style="background-color: #3665c2; color: white; margin-bottom: 10px; padding-left: 20px">
                <h4 style="width: 100%; padding-right: 10px; vertical-align: middle">ABP Spare Part- Wholesale<img style="float: right; cursor: pointer" id="imgdivEntry" src="../Images/grid_collapse.png" onclick="ShowHide(this,'divEntry')" /></h4>
            </div>
