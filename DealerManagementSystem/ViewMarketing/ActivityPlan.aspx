...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        function GetActivityData(ActivityID) {
            $.ajax({
                type: "POST",
                url: "ActivityPlan.aspx/GetActivityInfo",
        ...
        function SaveActivityPlan() {
            ...
            $.ajax({
                type: "POST",
                url: "ActivityPlan.aspx/SaveActivityPlan",
    ...
    <div class="col-md-12">
        <div class="col-md-12">
            <fieldset class="fieldset-border">
                <legend style="background: none; color: #007bff; font-size: 17px;">Activity Plan</legend>
                <div class="col-md-12">
                    ...
                    <div class="col-md-2 col-sm-12">
                        ...
                        <asp:DropDownList ID="ddlActivity" OnSelectedIndexChanged="ddlActivity_SelectedIndexChanged" runat="server" AutoPostBack="true" CssClass="form-control">
                        </asp:DropDownList>
                    </div>
                    <div class="col-md-2 col-sm-12">
                        <label for="txtFA" id="lblFA">Functional Area</label>
                        <%--<input type="text" disabled="disabled" runat="server" id="txtFA" CssClass="form-control"/>--%>
                        <asp:TextBox ID="txtFA" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox>
                    </div>
                    <div class="col-md-2 col-sm-12">
                        <label for="txtUnits" id="lblUnits" runat="server">No. of Units</label>
                        <%--<input type="text" runat="server" id="txtUnits" CssClass="form-control"/>--%>
                    ...
                    <div class="col-md-2 col-sm-12">
                        ...
                        <%--<input type="text" disabled="disabled" runat="server" id="txtBudget" cssclass="form-control" />--%>
                        <asp:TextBox ID="txtBudget" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox>
                    </div>
                    <div class="col-md-2 col-sm-12">
                        <label for="txtExpBudget">Expected Budget</label>
                        <%--<input type="text" disabled="disabled" runat="server" id="txtExpBudget" cssclass="form-control" />--%>
                        <asp:TextBox ID="txtExpBudget" runat="server" CssClass="form-control"></asp:TextBox>
                    </div>
                    <div class="col-md-2 col-sm-12">
                    ...
                    <div class="col-md-12 text-center">
                        <input type="submit" id="btnSubmit" class="btn Save" onclick="return SaveActivityPlan();" value="Submit" runat="server">
            ...
            <fieldset class="fieldset-border">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-2 text-left">
                        ...
                        <asp:Button ID="Search" runat="server" Text="Search" CssClass="btn Search" OnClick="Search_Click" Width="65px" />
                        <asp:Button ID="btnExcel" runat="server" Text="Excel" CssClass="btn Back" OnClick="btnExcel_Click" Width="65px" />
                    </div>
                </div>
            </fieldset>
        </div>
        <div class="col-md-12 Report">
            <fieldset class="fieldset-border">
                <legend style="background: none; color: #007bff; font-size: 17px;">Activity Plan Report</legend>
                <div class="col-md-12 Report">
